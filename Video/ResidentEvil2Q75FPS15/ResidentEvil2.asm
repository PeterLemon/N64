// N64 'Bare Metal' 320x240 YUV DCT 16-Bit LZSS DIFF RLE Video Decode Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
...
constant FRAMES(2085) // Number Of Frames
...
Q: // JPEG Standard Quantization 8x8 Result Matrix (Quality = 75)
...
insert LZVideo, "Video.lz" // 2085 320x240 LZ DIFF RLE Compressed YUV Frames