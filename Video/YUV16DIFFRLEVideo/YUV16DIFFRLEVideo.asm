// N64 'Bare Metal' 320x240 YUV DCT 16-Bit DIFF RLE Video Decode Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "YUV16DIFFRLEVideo.N64", create
...
LoopVideo:
  ...
  LoopFrames:
    ...
    ori t0,r0,44380-1 // T0 = Length Of DMA Transfer In Bytes - 1
