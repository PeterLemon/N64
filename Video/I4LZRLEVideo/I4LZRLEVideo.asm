// N64 'Bare Metal' 320x240 I4 LZSS RLE Video Decode Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "I4LZRLEVideo.N64", create
fill 1052672 // Set ROM Size

constant RLE($80300000) // RLE Frame DRAM Offset
constant I4($80380000)  // I4  Frame DRAM Offset
...
LoopVideo:
  ...
  la t0,I4+38400 // T0 = Destination End Offset (DRAM End Offset)
...
insert LZVideo, "Video.lz" // 6572 320x240 LZSS RLE Compressed I4 Frames