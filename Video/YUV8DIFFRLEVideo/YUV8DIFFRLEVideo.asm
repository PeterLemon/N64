// N64 'Bare Metal' 320x240 YUV DCT 8-Bit DIFF RLE Video Decode Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "YUV8DIFFRLEVideo.N64", create
fill 1052672 // Set ROM Size

constant DCTQ($80200000) // DCTQ Frame DRAM Offset
constant YUV($80300000)  // YUV  Frame DRAM Offset
...
LoopVideo:
  ...
  la a3,$10000000|(RLEVideo&$FFFFFFF) // A3 = Aligned Cart Physical ROM Offset ($10000000..$1FFFFFFF 128MB)
