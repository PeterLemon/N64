...
LoopVideo:
  ...
  LoopFrames:
    ...
    lli t0,37872-1 // T0 = Length Of DMA Transfer In Bytes - 1
...
TLUT: // 16x16Bx3 = 96 Bytes
  ...
  dw $0041, $00C1, $0141, $01C1, $0241, $02C1, $0341, $03C1, $0441, $04C1, $0541, $05C1, $0641, $06C1, $0741, $07C1 // 16x16B = 32 Bytes

  // Red Channel Palette 4
  dw $0801, $1801, $2801, $3801, $4801, $5801, $6801, $7801, $8801, $9801, $A801, $B801, $C801, $D801, $E801, $F801 // 16x16B = 32 Bytes

  // Blue Channel Palette 5
  dw $0003, $0007, $000B, $000F, $0013, $0017, $001B, $001F, $0023, $0027, $002B, $002F, $0033, $0037, $003B, $003F // 16x16B = 32 Bytes
