...
arch n64.cpu
endian msb
output "BigBuckBunny.N64", create
...
constant FRAMES(19039) // Number Of Frames
...
Start:
  ...
  li t0,(VI_NTSC_CLOCK/16000)-1 // T0 = Sample Frequency: (VI_NTSC_CLOCK(48681812) / FREQ(16000)) - 1
...
insert LZVideo, "Video.lz" // 19039 320x240 LZ DIFF RLE Compressed YUV Frames 