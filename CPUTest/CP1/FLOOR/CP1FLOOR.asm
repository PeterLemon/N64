...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,FLOORLD,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,8,88,FontRed,FLOORLS,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,8,152,FontRed,FLOORWD,8) // Print Text String To VRAM Using Font At X,Y Position
  la a0,VALUEDOUBLEA // A0 = Double Data Offset
  ldc1 f0,0(a0)      // F0 = Double Data
  ...
  PrintString($A0100000,8,216,FontRed,FLOORWS,8) // Print Text String To VRAM Using Font At X,Y Position
  la a0,VALUEFLOATA // A0 = Float Data Offset
  lwc1 f0,0(a0)     // F0 = Float Data
