...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,CNGLED,7) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,8,240,FontRed,CNGLES,7) // Print Text String To VRAM Using Font At X,Y Position
