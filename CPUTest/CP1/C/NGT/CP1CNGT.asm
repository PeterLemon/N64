...
ClearScreen:
  ...
  PrintString $A010,8,24,FontRed,CNGTD,6 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString $A010,8,240,FontRed,CNGTS,6 ; Print Text String To VRAM Using Font At X,Y Position
