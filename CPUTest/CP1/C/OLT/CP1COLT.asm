...
ClearScreen:
  ...
  PrintString $A010,8,24,FontRed,COLTD,6 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString $A010,8,240,FontRed,COLTS,6 ; Print Text String To VRAM Using Font At X,Y Position
