...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,CFD,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,8,240,FontRed,CFS,4) // Print Text String To VRAM Using Font At X,Y Position
