...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,CLTD,5) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,8,240,FontRed,CLTS,5) // Print Text String To VRAM Using Font At X,Y Position
