...
ClearScreen:
  ...
  PrintString $A010,8,24,FontRed,CNGED,6 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString $A010,8,240,FontRed,CNGES,6 ; Print Text String To VRAM Using Font At X,Y Position
