...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,SUBD,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,8,192,FontRed,SUBS,4) // Print Text String To VRAM Using Font At X,Y Position
