...
ClearScreen:
  ...
  PrintString $A010,8,32,FontRed,ABSS,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  ...
  PrintString $A010,8,40,FontRed,ADDD,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  ...
  PrintString $A010,8,48,FontRed,ADDS,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  ...
  PrintString $A010,8,56,FontRed,CEILLD,7 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,64,FontRed,CEILLS,7 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,72,FontRed,CEILWD,7 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,80,FontRed,CEILWS,7 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,88,FontRed,CVTDL,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,96,FontRed,CVTDS,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,104,FontRed,CVTDW,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,112,FontRed,CVTLD,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,120,FontRed,CVTLS,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,128,FontRed,CVTSD,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,136,FontRed,CVTSL,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,144,FontRed,CVTSW,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,152,FontRed,CVTWD,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,160,FontRed,CVTWS,6 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,168,FontRed,DIVD,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  la t1,VALUEDOUBLEB ; T1 = Double Data Offset
  ...
  PrintString $A010,8,176,FontRed,DIVS,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  la t1,VALUEFLOATB ; T1 = Float Data Offset
  ...
  PrintString $A010,8,184,FontRed,FLOORLD,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,192,FontRed,FLOORLS,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,200,FontRed,FLOORWD,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,208,FontRed,FLOORWS,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,216,FontRed,MULD,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  la t1,VALUEDOUBLEB ; T1 = Double Data Offset
  ...
  PrintString $A010,8,224,FontRed,MULS,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  la t1,VALUEFLOATB ; T1 = Float Data Offset
  ...
  PrintString $A010,8,232,FontRed,NEGD,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,240,FontRed,NEGS,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,248,FontRed,ROUNDLD,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,256,FontRed,ROUNDLS,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,264,FontRed,ROUNDWD,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,272,FontRed,ROUNDWS,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,280,FontRed,SQRTD,5 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,288,FontRed,SQRTS,5 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,296,FontRed,SUBD,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  la t1,VALUEDOUBLEB ; T1 = Double Data Offset
  ...
  PrintString $A010,8,304,FontRed,SUBS,4 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  la t1,VALUEFLOATB ; T1 = Float Data Offset
  ...
  PrintString $A010,8,312,FontRed,TRUNCLD,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,320,FontRed,TRUNCLS,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,328,FontRed,TRUNCWD,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEDOUBLEA ; T1 = Double Data Offset
  ldc1 f0,0(t1)      ; F0 = Double Data
  lui t3,VI_BASE
  ...
  PrintString $A010,8,336,FontRed,TRUNCWS,8 ; Print Text String To VRAM Using Font At X,Y Position
  li t0,0 ; T0 = Instruction Count
  la t1,VALUEFLOATA ; T1 = Float Data Offset
  lwc1 f0,0(t1)     ; F0 = Float Data
  lui t3,VI_BASE
  ...
  PrintString $A010,0,344,FontBlack,PAGEBREAK,79 ; Print Text String To VRAM Using Font At X,Y Position
...
VALUEDOUBLEB: IEEE64 1.0

VALUEFLOATA: IEEE32 0.0
VALUEFLOATB: IEEE32 1.0

ABSDCOUNT:    dw $0000DB1F
ABSSCOUNT:    dw $0000DB1C
ADDDCOUNT:    dw $0000CFB7
ADDSCOUNT:    dw $0000CFB5
CEILLDCOUNT:  dw $0000C341
CEILLSCOUNT:  dw $0000C344
CEILWDCOUNT:  dw $0000C340
CEILWSCOUNT:  dw $0000C341
CVTDLCOUNT:   dw $0000DABB
CVTDSCOUNT:   dw $0000DB1F
CVTDWCOUNT:   dw $0000DABA
CVTLDCOUNT:   dw $0000C341
CVTLSCOUNT:   dw $0000C341
CVTSDCOUNT:   dw $0000DABD
CVTSLCOUNT:   dw $0000DAB7
CVTSWCOUNT:   dw $0000DABB
CVTWDCOUNT:   dw $0000C342
CVTWSCOUNT:   dw $0000C344
DIVDCOUNT:    dw $0000DABA
DIVSCOUNT:    dw $0000DAB9
FLOORLDCOUNT: dw $0000C344
FLOORLSCOUNT: dw $0000C341
FLOORWDCOUNT: dw $0000C341
FLOORWSCOUNT: dw $0000C342
MULDCOUNT:    dw $0000DABA
MULSCOUNT:    dw $0000DAB9
NEGDCOUNT:    dw $0000DB1C
NEGSCOUNT:    dw $0000DB1F
ROUNDLDCOUNT: dw $0000C340
ROUNDLSCOUNT: dw $0000C341
ROUNDWDCOUNT: dw $0000C341
ROUNDWSCOUNT: dw $0000C344
SQRTDCOUNT:   dw $0000DABB
SQRTSCOUNT:   dw $0000DABB
SUBDCOUNT:    dw $0000CFB4
SUBSCOUNT:    dw $0000CFB5
TRUNCLDCOUNT: dw $0000C341
TRUNCLSCOUNT: dw $0000C342
TRUNCWDCOUNT: dw $0000C344
TRUNCWSCOUNT: dw $0000C341
