...
define header_title_27("Exception: TEQ (delay)     ")
...
Start:
  ...
  variable top(top + 16)
  ShowRow(top, ExceptPC_9, 8, ExceptPC, 0xFFFFFFFF, 0x8000121C, 0x80001220)

  variable top(top + 16)
  ShowRowNoBefore(top, Cause_6, 5, Cause, 0x00000034, 0x00000034)

  variable top(top + 16)
  ShowRow(top, Status_7, 6, Status, 0x241000E0, 0x241000E2, 0x241000E0)

  variable top(top + 16)
  ShowRow(top, BadVAddr_9, 8, BadVAddr, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF)

  variable top(top + 16)
  ShowRow(top, Context_8, 7, Context, 0x007FFFF0, 0x007FFFF0, 0x007FFFF0)
Loop:
  j Loop
  nop // Delay Slot
...
handler_180:
  ...
  // Increase EXCEPTPC by 4. Otherwise ERET and TNE will infinite-loop
  mfc0 r1, EXCEPTPC
  addiu r1, r1, 4
  mtc0 r1, EXCEPTPC

  // Need a minimum of 2 nops after changing TNE before eret will work
  nop
  nop
  eret
  nop
