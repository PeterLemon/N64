...
output "ExceptionUnaligned.n64", create
arch n64.cpu
endian msb
...
define header_title_27("Exception: Unaligned       ")
...
Start:
  ...
  variable top(top + 16)
  ShowRow(top, ExceptPC_9, 8, ExceptPC, 0xFFFFFFFF, 0x80001220, 0x80001224)

  variable top(top + 16)
  ShowRowNoBefore(top, Cause_6, 5, Cause, 0x00000010, 0x00000010)

  variable top(top + 16)
  ShowRow(top, Status_7, 6, Status, 0x241000E0, 0x241000E2, 0x241000E0)

  variable top(top + 16)
  ShowRowNoBefore(top, BadVAddr_9, 8, BadVAddr, 0x80000001, 0x80000001)

  variable top(top + 16)
  ShowRowNoBefore(top, Context_8, 7, Context, 0x00400000, 0x00400000)
Loop:
  j Loop
  nop // Delay Slot
