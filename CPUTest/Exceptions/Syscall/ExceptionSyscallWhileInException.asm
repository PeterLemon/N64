// Tests syscall instruction while in an exception
// Author: Lemmy with original sources from Peter Lemon's test sources
output "ExceptionSyscallWhileInException.n64", create
arch n64.cpu
endian msb
...
define header_title_27("Exception: SYSCALL (in exc)")
...
Start:
  ...
  variable top(top + 16)
  ShowRow(top, ExceptPC_9, 8, ExceptPC, 0xFFFFFFFF, 0x80001218, 0x8000121C)

  variable top(top + 16)
  ShowRowNoBefore(top, Cause_6, 5, Cause, 0x00000020, 0x00000020)

  variable top(top + 16)
  ShowRow(top, Status_7, 6, Status, 0x241000E0, 0x241000E2, 0x241000E0)

  variable top(top + 16)
  ShowRowNoCheck(top, BadVAddr_9, 8, BadVAddr)

  variable top(top + 16)
  ShowRowNoCheck(top, Context_8, 7, Context)
Loop:
  j Loop
  nop // Delay Slot
...
skip:
  ...
  // Increase EXCEPTPC by 4. Otherwise ERET and SYSCALL will infinite-loop
  la r1, Nested
  lw r1, 0(r1)
  addiu r1, r1, 4
  mtc0 r1, EXCEPTPC
