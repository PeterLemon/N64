// Tests memory writing with tlb miss
// Author: Lemmy with original sources from Peter Lemon's test sources
output "ExceptionTLBWriteMiss.n64", create
arch n64.cpu
endian msb
...
define header_title_27("Exception: TLB write miss  ")
...
Start:
  ...
  variable top(top + 16)
  ShowRowNoBefore(top, Cause_6, 5, Cause, 0x0000000C, 0x0000000C)
