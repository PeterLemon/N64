// Tests memory reading with tlb miss
// Author: Lemmy with original sources from Peter Lemon's test sources
output "ExceptionTLBReadMissNestedDelay.n64", create
arch n64.cpu
endian msb
...
define header_title_27("Exc: TLB-R-Miss, nested+del")
...
macro PrintPassValueMatches(left, top, source, expected) {
...
macro ShowRowNoCheck(top, label, labelLength, data) {
  PrintString($A0100000, (16), ({top}), FontBlack, {label}, {labelLength})
  PrintValue($A0100000, (112), ({top}), FontBlack, {data}, 3)
  PrintValue($A0100000, (188), ({top}), FontBlack, ({data}+4), 3)
  PrintValue($A0100000, (264), ({top}), FontBlack, ({data}+8), 3)
...
target:
  ...
  PrintPassValueMatches(340, (top), HandlerPC, 0x80000180)

  variable top(top + 16)
  ShowRow(top, ErrorPC_8, 7, ErrorPC, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF)

  variable top(top + 16)
  ShowRow(top, ExceptPC_9, 8, ExceptPC, 0xFFFFFFFF, 0x80001250, 0x80001254)

  variable top(top + 16)
  ShowRowNoBefore(top, Cause_6, 5, Cause, 0x80000008, 0x80000008)

  variable top(top + 16)
  ShowRow(top, Status_7, 6, Status, 0x241000E0, 0x241000E2, 0x241000E0)

  variable top(top + 16)
  ShowRowNoBefore(top, BadVAddr_9, 8, BadVAddr, 0x00000020, 0x00000020)

  variable top(top + 16)
  ShowRowNoBefore(top, Context_8, 7, Context, 0x00000000, 0x00000000)

  variable top(top + 16)
  ShowRowNoCheck(top, EntryHi_8, 7, EntryHi)

  variable top(top + 16)
  ShowRowNoCheck(top, EntryLo0_9, 7, EntryLo0)

  variable top(top + 16)
  ShowRowNoCheck(top, EntryLo1_9, 7, EntryLo1)
Loop:
  j Loop
  nop // Delay Slot
...
align(0x100)
handler_80:
  // first exception will land here
  // cause another exception. this will send us to 0x80000180
  li r1, 0x00000020
  lw r2, 0(r1)
  nop
  nop
...
handler_180:
  ...
  // Increase EXCEPTPC by 4. Otherwise ERET and LW will infinite-loop
  mfc0 r1, EXCEPTPC
  addiu r1, r1, 4
  mtc0 r1, EXCEPTPC
