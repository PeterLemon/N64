// Tests memory writing with tlb miss in delay slot
// Author: Lemmy with original sources from Peter Lemon's test sources
output "ExceptionTLBWriteMissDelay.n64", create
arch n64.cpu
endian msb
...
define header_title_27("Exception: TLB-WMiss(delay)")
...
target:
  ...
  PrintPassValueMatches(340, (top), HandlerPC, 0x80000080)
  ...
  variable top(top + 16)
  ShowRowNoBefore(top, Cause_6, 5, Cause, 0x8000000C, 0x8000000C)

  variable top(top + 16)
  ShowRow(top, Status_7, 6, Status, 0x241000E0, 0x241000E2, 0x241000E0)

  variable top(top + 16)
  ShowRowNoBefore(top, BadVAddr_9, 8, BadVAddr, 0x00000010, 0x00000010)
