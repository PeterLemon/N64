...
output "ExceptionTLBReadMissNested.n64", create
arch n64.cpu
endian msb
...
define header_title_27("Exception: TLB-RMiss nested")
...
Start:
  ...
  variable top(top + 16)
  ShowRowNoBefore(top, Cause_6, 5, Cause, 0x00000008, 0x00000008)
