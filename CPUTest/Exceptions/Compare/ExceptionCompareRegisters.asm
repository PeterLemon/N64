// Tests COMPARE exception
// Author: Lemmy with original sources from Peter Lemon's test sources
output "ExceptionCompareRegisters.n64", create
arch n64.cpu
endian msb
...
define header_title_27("Exc: Compare (registers)   ")
...
macro PrintPassIfValuesAreInList(left, top, source1, expected1a, expected1b, source2, expected2a, expected2b) {
    lui r1, 0   // this becomes 1 if any value differs
...
macro InstallExceptionHandlers() {
    ...
    memcpy(0x80000180, handler_180, 0x200)
...
Start:
  ...
  // Enable interrupts in general and COMPARE exception specifically
  mfc0 r1, STATUS
  ori r1, r1, 0x8001
  mtc0 r1, STATUS
  ...
  PrintString($A0100000, (16), (32), FontBlack, Wait_7, 6)
...
PostLoop:
  ...
  PrintPassIfValueMatches(340, top, HandlerPC, 0x80000180)

  variable top(top + 16)
  ShowRow(top, ErrorPC_8, 7, ErrorPC, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF)

  variable top(top + 16)
  PrintString($A0100000, (16), (top), FontBlack, ExceptPC_9, 8)
  PrintValue($A0100000, (112), (top), FontBlack, ExceptPC, 3)
  PrintValue($A0100000, (188), (top), FontBlack, (ExceptPC + 4), 3)
  PrintPassIf1ValueMatchesAnd1IsInRange(340, (top), ExceptPC, 0xFFFFFFFF, (ExceptPC + 4), 0x800012AC, 0x800012BC)

  variable top(top + 16)
  PrintString($A0100000, (16), (top), FontBlack, Cause_6, 5)
  PrintValue($A0100000, (188), (top), FontBlack, (Cause+4), 3)
  PrintValue($A0100000, (264), (top), FontBlack, (Cause+8), 3)
  PrintPassIfValuesAreInList(340, (top), (Cause+4), 0x00008000, 0x80008000, (Cause+8), 0x00008000, 0x80008000)

  variable top(top + 16)
  ShowRow(top, Status_7, 6, Status, 0x241000E0, 0x241080E3, 0x241000E0)
Loop:
  j Loop
  nop // Delay Slot
