...
output "DMAAlignment-PI-ROM-FROM_large_4.N64", create
arch n64.cpu
endian msb
...
Start:
  ...
  ZeroMemory()
  DMAFrom(data + 4, 0x10001000, 255)
  PrintData(From0to15  	, 8, 10 * 2, 0x0000, 0x000051ce)
  PrintData(From16to31 	, 8, 10 * 3, 0x0010, 0x000e5fb0)
  PrintData(From32to47	, 8, 10 * 4, 0x0020, 0x0008fdc4)
  PrintData(From48to63	, 8, 10 * 5, 0x0030, 0x00757140)
  PrintData(From64to79	, 8, 10 * 6, 0x0040, 0x00743b10)
  PrintData(From80to95	, 8, 10 * 7, 0x0050, 0x001fd790)
  PrintData(From96to111	, 8, 10 * 8, 0x0060, 0x001d22c0)
  PrintData(From112to127, 8, 10 * 9, 0x0070, 0x00117A50)
  PrintData(From128to143, 8, 10 *10, 0x0080, 0x007751c0)
  PrintData(From144to159, 8, 10 *11, 0x0090, 0x001fefc0)
  PrintData(From160to175, 8, 10 *12, 0x00a0, 0x000e60b6)
  PrintData(From176to191, 8, 10 *13, 0x00b0, 0x00009bb4)
  PrintData(From192to207, 8, 10 *14, 0x00c0, 0x00381144)
  PrintData(From208to223, 8, 10 *15, 0x00d0, 0x00122de4)
  PrintData(From224to239, 8, 10 *16, 0x00e0, 0x000f6780)
  PrintData(From240to255, 8, 10 *17, 0x00f0, 0x000000ac)
  PrintData(From256to271, 8, 10 *18, 0x0100, 0x00124000)
