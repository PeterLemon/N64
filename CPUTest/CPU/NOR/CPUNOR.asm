...
ClearScreen:
  ...
  ld t0,0(a0)     ; T0 = Long Data
  la a0,NORCHECKA ; A0 = Long Check Data Offset
  ...
  la a0,RDLONG    ; A0 = Long Data Offset
  ld t0,0(a0)     ; T0 = Long Data
  la a0,NORCHECKB ; A0 = Long Check Data Offset
  ld t1,0(a0)     ; T1 = Long Check Data
  ...
  la a0,RDLONG    ; A0 = Long Data Offset
  ld t0,0(a0)     ; T0 = Long Data
  la a0,NORCHECKC ; A0 = Long Check Data Offset
  ld t1,0(a0)     ; T1 = Long Check Data
  ...
  la a0,RDLONG    ; A0 = Long Data Offset
  ld t0,0(a0)     ; T0 = Long Data
  la a0,NORCHECKD ; A0 = Long Check Data Offset
  ld t1,0(a0)     ; T1 = Long Check Data
  ...
  la a0,RDLONG    ; A0 = Long Data Offset
  ld t0,0(a0)     ; T0 = Long Data
  la a0,NORCHECKE ; A0 = Long Check Data Offset
  ld t1,0(a0)     ; T1 = Long Check Data
  ...
  la a0,RDLONG    ; A0 = Long Data Offset
  ld t0,0(a0)     ; T0 = Long Data
  la a0,NORCHECKF ; A0 = Long Check Data Offset
  ld t1,0(a0)     ; T1 = Long Check Data
  ...
  la a0,RDLONG    ; A0 = Long Data Offset
  ld t0,0(a0)     ; T0 = Long Data
  la a0,NORCHECKG ; A0 = Long Check Data Offset
  ld t1,0(a0)     ; T1 = Long Check Data
