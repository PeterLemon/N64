; N64 'Bare Metal' CPU Bitwise Logical NOT OR Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  la t0,NORCHECKA ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,NORPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG    ; T0 = Long Data Offset
  ld t1,0(t0)     ; T1 = Long Data
  la t0,NORCHECKB ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,NORPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG    ; T0 = Long Data Offset
  ld t1,0(t0)     ; T1 = Long Data
  la t0,NORCHECKC ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,NORPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG    ; T0 = Long Data Offset
  ld t1,0(t0)     ; T1 = Long Data
  la t0,NORCHECKD ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,NORPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG    ; T0 = Long Data Offset
  ld t1,0(t0)     ; T1 = Long Data
  la t0,NORCHECKE ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,NORPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG    ; T0 = Long Data Offset
  ld t1,0(t0)     ; T1 = Long Data
  la t0,NORCHECKF ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,NORPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG    ; T0 = Long Data Offset
  ld t1,0(t0)     ; T1 = Long Data
  la t0,NORCHECKG ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,NORPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
...
NORCHECKA: data $FFD423AB9E9B9ADD
NORCHECKB: data $FFD423AB96099808
NORCHECKC: data $FFD423ABA0692920
NORCHECKD: data $FE4020A0012B20A0
NORCHECKE: data $FE4964B40023A082
NORCHECKF: data $FE4964B420000082
NORCHECKG: data $FE4964B432140CA6
