...
ClearScreen:
  ...
  la t0,ADDUCHECKA ; T0 = Word Check Data Offset
  lw t2,0(t0)      ; T2 = Word Check Data
  beq t1,t2,ADDUPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD     ; T0 = Word Data Offset
  lw t1,0(t0)      ; T1 = Word Data
  la t0,ADDUCHECKB ; T0 = Word Check Data Offset
  lw t2,0(t0)      ; T2 = Word Check Data
  beq t1,t2,ADDUPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD     ; T0 = Word Data Offset
  lw t1,0(t0)      ; T1 = Word Data
  la t0,ADDUCHECKC ; T0 = Word Check Data Offset
  lw t2,0(t0)      ; T2 = Word Check Data
  beq t1,t2,ADDUPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD     ; T0 = Word Data Offset
  lw t1,0(t0)      ; T1 = Word Data
  la t0,ADDUCHECKD ; T0 = Word Check Data Offset
  lw t2,0(t0)      ; T2 = Word Check Data
  beq t1,t2,ADDUPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD     ; T0 = Word Data Offset
  lw t1,0(t0)      ; T1 = Word Data
  la t0,ADDUCHECKE ; T0 = Word Check Data Offset
  lw t2,0(t0)      ; T2 = Word Check Data
  beq t1,t2,ADDUPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD     ; T0 = Word Data Offset
  lw t1,0(t0)      ; T1 = Word Data
  la t0,ADDUCHECKF ; T0 = Word Check Data Offset
  lw t2,0(t0)      ; T2 = Word Check Data
  beq t1,t2,ADDUPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD     ; T0 = Word Data Offset
  lw t1,0(t0)      ; T1 = Word Data
  la t0,ADDUCHECKG ; T0 = Word Check Data Offset
  lw t2,0(t0)      ; T2 = Word Check Data
  beq t1,t2,ADDUPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,ADDIUCHECKA ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,ADDIUPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,ADDIUCHECKB ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,ADDIUPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,ADDIUCHECKD ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,ADDIUPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,ADDIUCHECKF ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,ADDIUPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,ADDIUCHECKG ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,ADDIUPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
