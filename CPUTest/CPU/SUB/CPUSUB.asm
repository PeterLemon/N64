; N64 'Bare Metal' CPU Signed Word Subtraction Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  PrintString $A010,8,24,FontRed,SUB,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la t0,SUBCHECKA ; T0 = Word Check Data Offset
  lw t2,0(t0)     ; T2 = Word Check Data
  beq t1,t2,SUBPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD    ; T0 = Word Data Offset
  lw t1,0(t0)     ; T1 = Word Data
  la t0,SUBCHECKB ; T0 = Word Check Data Offset
  lw t2,0(t0)     ; T2 = Word Check Data
  beq t1,t2,SUBPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD    ; T0 = Word Data Offset
  lw t1,0(t0)     ; T1 = Word Data
  la t0,SUBCHECKC ; T0 = Word Check Data Offset
  lw t2,0(t0)     ; T2 = Word Check Data
  beq t1,t2,SUBPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD    ; T0 = Word Data Offset
  lw t1,0(t0)     ; T1 = Word Data
  la t0,SUBCHECKD ; T0 = Word Check Data Offset
  lw t2,0(t0)     ; T2 = Word Check Data
  beq t1,t2,SUBPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD    ; T0 = Word Data Offset
  lw t1,0(t0)     ; T1 = Word Data
  la t0,SUBCHECKE ; T0 = Word Check Data Offset
  lw t2,0(t0)     ; T2 = Word Check Data
  beq t1,t2,SUBPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD    ; T0 = Word Data Offset
  lw t1,0(t0)     ; T1 = Word Data
  la t0,SUBCHECKF ; T0 = Word Check Data Offset
  lw t2,0(t0)     ; T2 = Word Check Data
  beq t1,t2,SUBPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDWORD    ; T0 = Word Data Offset
  lw t1,0(t0)     ; T1 = Word Data
  la t0,SUBCHECKG ; T0 = Word Check Data Offset
  lw t2,0(t0)     ; T2 = Word Check Data
  beq t1,t2,SUBPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
...
SUBCHECKA: dw $F8A432EB
SUBCHECKB: dw $0759EAD5
SUBCHECKC: dw $F8A62ADE
SUBCHECKD: dw $0EB76EC4
SUBCHECKE: dw $F8A62ADE
SUBCHECKF: dw $0759EAD5
SUBCHECKG: dw $075BCD15
