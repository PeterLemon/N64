...
ClearScreen:
  ...
  la t0,DSUBCHECKA ; T0 = Long Check Data Offset
  ld t2,0(t0)      ; T2 = Long Check Data
  beq t1,t2,DSUBPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG     ; T0 = Long Data Offset
  ld t1,0(t0)      ; T1 = Long Data
  la t0,DSUBCHECKB ; T0 = Long Check Data Offset
  ld t2,0(t0)      ; T2 = Long Check Data
  beq t1,t2,DSUBPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG     ; T0 = Long Data Offset
  ld t1,0(t0)      ; T1 = Long Data
  la t0,DSUBCHECKC ; T0 = Long Check Data Offset
  ld t2,0(t0)      ; T2 = Long Check Data
  beq t1,t2,DSUBPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG     ; T0 = Long Data Offset
  ld t1,0(t0)      ; T1 = Long Data
  la t0,DSUBCHECKD ; T0 = Long Check Data Offset
  ld t2,0(t0)      ; T2 = Long Check Data
  beq t1,t2,DSUBPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG     ; T0 = Long Data Offset
  ld t1,0(t0)      ; T1 = Long Data
  la t0,DSUBCHECKE ; T0 = Long Check Data Offset
  ld t2,0(t0)      ; T2 = Long Check Data
  beq t1,t2,DSUBPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG     ; T0 = Long Data Offset
  ld t1,0(t0)      ; T1 = Long Data
  la t0,DSUBCHECKF ; T0 = Long Check Data Offset
  ld t2,0(t0)      ; T2 = Long Check Data
  beq t1,t2,DSUBPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG    ; T0 = Long Data Offset
  ld t1,0(t0)     ; T1 = Long Data
  la t0,DSUBCHECKG ; T0 = Long Check Data Offset
  ld t2,0(t0)     ; T2 = Long Check Data
  beq t1,t2,DSUBPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
