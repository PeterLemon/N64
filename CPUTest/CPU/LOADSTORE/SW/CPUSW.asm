...
ClearScreen:
  ...
  PrintString($A0100000,296,88,FontBlack,TEXTLONGB,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,296,104,FontBlack,TEXTLONGB,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,296,112,FontBlack,TEXTLONGB,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintValue($A0100000,88,120,FontBlack,VALUELONGG,7) // Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString($A0100000,288,120,FontBlack,TEXTLONGG,9) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintValue($A0100000,88,128,FontBlack,VALUELONGG,7) // Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString($A0100000,288,128,FontBlack,TEXTLONGG,9) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintValue($A0100000,88,144,FontBlack,VALUELONGG,7) // Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString($A0100000,288,144,FontBlack,TEXTLONGG,9) // Print Text String To VRAM Using Font At X,Y Position
  PrintString($A0100000,440,144,FontBlack,DOLLAR,0) // Print Text String To VRAM Using Font At X,Y Position
  PrintValue($A0100000,448,144,FontBlack,WORD,3) // Print Text String To VRAM Using Font At X,Y Position
  la a0,WORD      // A0 = Word Data Offset
  lw t0,0(a0)     // T0 = Word Data
  la a0,SWLCHECKH // A0 = Word Check Data Offset
  lw t1,0(a0)     // T1 = Word Check Data
  ...
  PrintString($A0100000,8,160,FontRed,SWR,2) // Print Text String To VRAM Using Font At X,Y Position
  la a0,VALUELONGB // A0 = Long Data Offset
  ld t0,0(a0)  // T0 = Test Long Data
  la a0,WORD   // A0 = WORD Offset
  ...
  ld t0,0(a0)  // T0 = Test Long Data
  la a0,WORD   // A0 = WORD Offset
  swr t0,1(a0) // WORD = Word Data
  PrintString($A0100000,80,168,FontBlack,DOLLAR,0) // Print Text String To VRAM Using Font At X,Y Position
  PrintValue($A0100000,88,168,FontBlack,VALUELONGB,7) // Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString($A0100000,296,168,FontBlack,TEXTLONGB,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  ld t0,0(a0)  // T0 = Test Long Data
  la a0,WORD   // A0 = WORD Offset
  swr t0,2(a0) // WORD = Word Data
  PrintString($A0100000,80,176,FontBlack,DOLLAR,0) // Print Text String To VRAM Using Font At X,Y Position
  PrintValue($A0100000,88,176,FontBlack,VALUELONGB,7) // Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString($A0100000,296,176,FontBlack,TEXTLONGB,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  ld t0,0(a0)  // T0 = Test Long Data
  la a0,WORD   // A0 = WORD Offset
  swr t0,3(a0) // WORD = Word Data
  PrintString($A0100000,80,184,FontBlack,DOLLAR,0) // Print Text String To VRAM Using Font At X,Y Position
  PrintValue($A0100000,88,184,FontBlack,VALUELONGB,7) // Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString($A0100000,296,184,FontBlack,TEXTLONGB,8) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,288,192,FontBlack,TEXTLONGG,9) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,288,208,FontBlack,TEXTLONGG,9) // Print Text String To VRAM Using Font At X,Y Position
  PrintString($A0100000,440,208,FontBlack,DOLLAR,0) // Print Text String To VRAM Using Font At X,Y Position
  PrintValue($A0100000,448,208,FontBlack,WORD,3) // Print Text String To VRAM Using Font At X,Y Position
  la a0,WORD      // A0 = Word Data Offset
  lw t0,0(a0)     // T0 = Word Data
  ...
  PrintValue($A0100000,88,216,FontBlack,VALUELONGG,7) // Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString($A0100000,288,216,FontBlack,TEXTLONGG,9) // Print Text String To VRAM Using Font At X,Y Position
  PrintString($A0100000,440,216,FontBlack,DOLLAR,0) // Print Text String To VRAM Using Font At X,Y Position
  PrintValue($A0100000,448,216,FontBlack,WORD,3) // Print Text String To VRAM Using Font At X,Y Position
  la a0,WORD      // A0 = Word Data Offset
  lw t0,0(a0)     // T0 = Word Data
  la a0,SWRCHECKH // A0 = Word Check Data Offset
  lw t1,0(a0)     // T1 = Word Check Data
  ...
  PrintString($A0100000,0,224,FontBlack,PAGEBREAK,79) // Print Text String To VRAM Using Font At X,Y Position
