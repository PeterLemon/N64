...
ClearScreen:
  ...
  PrintString $A010,8,24,FontRed,DIV,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la t0,DIVLOCHECKA ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVLOPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVHICHECKA ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVHIPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,LOWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVLOCHECKB ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVLOPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,HIWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVHICHECKB ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVHIPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,LOWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVLOCHECKC ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVLOPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,HIWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVHICHECKC ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVHIPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,LOWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVLOCHECKD ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVLOPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,HIWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVHICHECKD ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVHIPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,LOWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVLOCHECKE ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVLOPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,HIWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVHICHECKE ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVHIPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,LOWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVLOCHECKF ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVLOPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,HIWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVHICHECKF ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVHIPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,LOWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVLOCHECKG ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVLOPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,HIWORD      ; T0 = Word Data Offset
  lw t1,0(t0)       ; T1 = Word Data
  la t0,DIVHICHECKG ; T0 = Word Check Data Offset
  lw t2,0(t0)       ; T2 = Word Check Data
  beq t1,t2,DIVHIPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
...
DIVLOCHECKA: dw $00000000
DIVHICHECKA: dw $00000000
DIVLOCHECKB: dw $000003E8
DIVHICHECKB: dw $00000315
DIVLOCHECKC: dw $00000000
DIVHICHECKC: dw $0001E240
DIVLOCHECKD: dw $FFFFFFFF
DIVHICHECKD: dw $00000000
DIVLOCHECKE: dw $000003E7
DIVHICHECKE: dw $FFFE305E
DIVLOCHECKF: dw $00000000
DIVHICHECKF: dw $FFFE1DC0
DIVLOCHECKG: dw $00000000
DIVHICHECKG: dw $00000000
