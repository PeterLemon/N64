...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,DADDU,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,8,192,FontRed,DADDIU,5) // Print Text String To VRAM Using Font At X,Y Position
  la a0,VALUELONGA // A0 = Long Data Offset
  ld t0,0(a0)      // T0 = Long Data
