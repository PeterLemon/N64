...
ClearScreen:
  ...
  la t0,DADDUCHECKA ; T0 = Long Check Data Offset
  ld t2,0(t0)       ; T2 = Long Check Data
  beq t1,t2,DADDUPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG      ; T0 = Long Data Offset
  ld t1,0(t0)       ; T1 = Long Data
  la t0,DADDUCHECKB ; T0 = Long Check Data Offset
  ld t2,0(t0)       ; T2 = Long Check Data
  beq t1,t2,DADDUPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG      ; T0 = Long Data Offset
  ld t1,0(t0)       ; T1 = Long Data
  la t0,DADDUCHECKC ; T0 = Long Check Data Offset
  ld t2,0(t0)       ; T2 = Long Check Data
  beq t1,t2,DADDUPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG      ; T0 = Long Data Offset
  ld t1,0(t0)       ; T1 = Long Data
  la t0,DADDUCHECKD ; T0 = Long Check Data Offset
  ld t2,0(t0)       ; T2 = Long Check Data
  beq t1,t2,DADDUPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG      ; T0 = Long Data Offset
  ld t1,0(t0)       ; T1 = Long Data
  la t0,DADDUCHECKE ; T0 = Long Check Data Offset
  ld t2,0(t0)       ; T2 = Long Check Data
  beq t1,t2,DADDUPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG      ; T0 = Long Data Offset
  ld t1,0(t0)       ; T1 = Long Data
  la t0,DADDUCHECKF ; T0 = Long Check Data Offset
  ld t2,0(t0)       ; T2 = Long Check Data
  beq t1,t2,DADDUPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG      ; T0 = Long Data Offset
  ld t1,0(t0)       ; T1 = Long Data
  la t0,DADDUCHECKG ; T0 = Long Check Data Offset
  ld t2,0(t0)       ; T2 = Long Check Data
  beq t1,t2,DADDUPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG       ; T0 = Long Data Offset
  ld t1,0(t0)        ; T1 = Long Data
  la t0,DADDIUCHECKA ; T0 = Long Check Data Offset
  ld t2,0(t0)        ; T2 = Long Check Data
  beq t1,t2,DADDIUPASSA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG       ; T0 = Long Data Offset
  ld t1,0(t0)        ; T1 = Long Data
  la t0,DADDIUCHECKB ; T0 = Long Check Data Offset
  ld t2,0(t0)        ; T2 = Long Check Data
  beq t1,t2,DADDIUPASSB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG       ; T0 = Long Data Offset
  ld t1,0(t0)        ; T1 = Long Data
  la t0,DADDIUCHECKC ; T0 = Long Check Data Offset
  ld t2,0(t0)        ; T2 = Long Check Data
  beq t1,t2,DADDIUPASSC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG       ; T0 = Long Data Offset
  ld t1,0(t0)        ; T1 = Long Data
  la t0,DADDIUCHECKD ; T0 = Long Check Data Offset
  ld t2,0(t0)        ; T2 = Long Check Data
  beq t1,t2,DADDIUPASSD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG       ; T0 = Long Data Offset
  ld t1,0(t0)        ; T1 = Long Data
  la t0,DADDIUCHECKE ; T0 = Long Check Data Offset
  ld t2,0(t0)        ; T2 = Long Check Data
  beq t1,t2,DADDIUPASSE ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG       ; T0 = Long Data Offset
  ld t1,0(t0)        ; T1 = Long Data
  la t0,DADDIUCHECKF ; T0 = Long Check Data Offset
  ld t2,0(t0)        ; T2 = Long Check Data
  beq t1,t2,DADDIUPASSF ; Compare Result Equality With Check Data
  nop ; Delay Slot
  ...
  la t0,RDLONG       ; T0 = Long Data Offset
  ld t1,0(t0)        ; T1 = Long Data
  la t0,DADDIUCHECKG ; T0 = Long Check Data Offset
  ld t2,0(t0)        ; T2 = Long Check Data
  beq t1,t2,DADDIUPASSG ; Compare Result Equality With Check Data
  nop ; Delay Slot
