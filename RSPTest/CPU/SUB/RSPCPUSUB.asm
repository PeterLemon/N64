...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,SUB,2) // Print Text String To VRAM Using Font At X,Y Position
...
base RSPSUBCode+pc() // Set End Of RSP Code Object
RSPSUBCodeEnd:
