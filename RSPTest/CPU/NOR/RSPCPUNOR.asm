; N64 'Bare Metal' RSP CPU Bitwise Logical NOT OR Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPNORCode, RSPNORCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  la a0,NORCHECKA ; A0 = Word Check Data Offset
  ...
  la a0,RDWORD    ; A0 = Word Data Offset
  lw t0,0(a0)     ; T0 = Word Data
  la a0,NORCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)     ; T1 = Word Check Data
  ...
  la a0,RDWORD    ; A0 = Word Data Offset
  lw t0,0(a0)     ; T0 = Word Data
  la a0,NORCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)     ; T1 = Word Check Data
  ...
  la a0,RDWORD    ; A0 = Word Data Offset
  lw t0,0(a0)     ; T0 = Word Data
  la a0,NORCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)     ; T1 = Word Check Data
  ...
  la a0,RDWORD    ; A0 = Word Data Offset
  lw t0,0(a0)     ; T0 = Word Data
  la a0,NORCHECKE ; A0 = Word Check Data Offset
  lw t1,0(a0)     ; T1 = Word Check Data
  ...
  la a0,RDWORD    ; A0 = Word Data Offset
  lw t0,0(a0)     ; T0 = Word Data
  la a0,NORCHECKF ; A0 = Word Check Data Offset
  lw t1,0(a0)     ; T1 = Word Check Data
  ...
  la a0,RDWORD    ; A0 = Word Data Offset
  lw t0,0(a0)     ; T0 = Word Data
  la a0,NORCHECKG ; A0 = Word Check Data Offset
  lw t1,0(a0)     ; T1 = Word Check Data
...
NORCHECKA: dw $F8A432EA
NORCHECKB: dw $F8A410AA
NORCHECKC: dw $F8A4089D
NORCHECKD: dw $B0204004
NORCHECKE: dw $B6680020
NORCHECKF: dw $B6692928
NORCHECKG: dw $B669FD2C
