...
ClearScreen:
  ...
  PrintString($A0100000,8,24,FontRed,NOR,2) // Print Text String To VRAM Using Font At X,Y Position
...
base RSPNORCode+pc() // Set End Of RSP Code Object
RSPNORCodeEnd:
