...
ClearScreen:
  ...
  DMASPRD(RSPADDUCode, RSPADDUCodeEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPADDIUCodeA, RSPADDIUCodeAEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPADDIUCodeB, RSPADDIUCodeBEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPADDIUCodeC, RSPADDIUCodeCEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPADDIUCodeD, RSPADDIUCodeDEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPADDIUCodeE, RSPADDIUCodeEEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPADDIUCodeF, RSPADDIUCodeFEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
...
base RSPADDUCode+pc() // Set End Of RSP Code Object
RSPADDUCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  sw t0,0(a0) // RSP DMEM = Test Word Data
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
base RSPADDIUCodeA+pc() // Set End Of RSP Code Object
RSPADDIUCodeAEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  sw t0,0(a0) // RSP DMEM = Test Word Data
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
base RSPADDIUCodeB+pc() // Set End Of RSP Code Object
RSPADDIUCodeBEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  sw t0,0(a0) // RSP DMEM = Test Word Data
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
base RSPADDIUCodeC+pc() // Set End Of RSP Code Object
RSPADDIUCodeCEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  sw t0,0(a0) // RSP DMEM = Test Word Data
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
base RSPADDIUCodeD+pc() // Set End Of RSP Code Object
RSPADDIUCodeDEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  sw t0,0(a0) // RSP DMEM = Test Word Data
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
base RSPADDIUCodeE+pc() // Set End Of RSP Code Object
RSPADDIUCodeEEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  sw t0,0(a0) // RSP DMEM = Test Word Data
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
base RSPADDIUCodeF+pc() // Set End Of RSP Code Object
RSPADDIUCodeFEnd:
