...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VSUBTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VSUBCTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VSUBVDCHECKA:
  dw $FFEF, $DDCD, $BBAB, $9989, $7767, $5545, $3323, $1101
VSUBVDCHECKB:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSUBVDCHECKC:
  dw $0023, $4467, $7FFF, $7FFF, $8000, $8000, $99BB, $DDFF
VSUBVDCHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
...
VSUBCVDCHECKB:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSUBCVDCHECKC:
  dw $0023, $4467, $88AB, $CCEF, $1133, $5577, $99BB, $DDFF
VSUBCVDCHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vsub v0,v1[e0] // V0 = V0 - V1[0], Vector Subtract Short Elements: VSUB VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVSUBCode+pc() // Set End Of RSP Code Object
RSPVSUBCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVSUBCCode+pc() // Set End Of RSP Code Object
RSPVSUBCCodeEnd:
