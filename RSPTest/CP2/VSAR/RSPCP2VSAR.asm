...
ClearScreen:
  ...
  DMASPRD RSPVSARH0Code, RSPVSARH0CodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,VSARHTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,0,32,FontGreen,E0TEXT,3  ; Print Text String To VRAM Using Font At X,Y Position
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVSARM1Code, RSPVSARM1CodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,72,FontRed,VSARMTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,0,80,FontGreen,E1TEXT,3  ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,48,72,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,72,FontBlack,VALUEQUADA,7   ; Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString $A010,48,80,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,80,FontBlack,VALUEQUADA+8,7 ; Print HEX Chars To VRAM Using Font At X,Y Position
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVSARL2Code, RSPVSARL2CodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,120,FontRed,VSARLTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,0,128,FontGreen,E2TEXT,3  ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,48,120,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,120,FontBlack,VALUEQUADA,7   ; Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString $A010,48,128,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,128,FontBlack,VALUEQUADA+8,7 ; Print HEX Chars To VRAM Using Font At X,Y Position

  PrintString $A010,48,144,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,144,FontBlack,VALUEQUADB,7   ; Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString $A010,48,152,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,152,FontBlack,VALUEQUADB+8,7 ; Print HEX Chars To VRAM Using Font At X,Y Position
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVSARH8Code, RSPVSARH8CodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,VSARHTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,0,224,FontGreen,E8TEXT,3  ; Print Text String To VRAM Using Font At X,Y Position
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVSARM9Code, RSPVSARM9CodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,264,FontRed,VSARMTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,0,272,FontGreen,E9TEXT,3  ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,48,264,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,264,FontBlack,VALUEQUADA,7   ; Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString $A010,48,272,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,272,FontBlack,VALUEQUADA+8,7 ; Print HEX Chars To VRAM Using Font At X,Y Position
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVSARLACode, RSPVSARLACodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,312,FontRed,VSARLTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,0,320,FontGreen,EATEXT,3  ; Print Text String To VRAM Using Font At X,Y Position
  PrintString $A010,48,312,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,312,FontBlack,VALUEQUADA,7   ; Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString $A010,48,320,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,320,FontBlack,VALUEQUADA+8,7 ; Print HEX Chars To VRAM Using Font At X,Y Position

  PrintString $A010,48,336,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,336,FontBlack,VALUEQUADB,7   ; Print HEX Chars To VRAM Using Font At X,Y Position
  PrintString $A010,48,344,FontBlack,DOLLAR,0       ; Print Text String To VRAM Using Font At X,Y Position
  PrintValue  $A010,56,344,FontBlack,VALUEQUADB+8,7 ; Print HEX Chars To VRAM Using Font At X,Y Position
...
VALUEQUADA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VALUEQUADAEND:

VALUEQUADB: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VALUEQUADBEND:

VSARH0VDCHECK: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSARM1VDCHECK: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSARL2VDCHECK: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

VSARH8VDCHECK: dh $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
VSARM9VDCHECK: dh $FFB7, $8976, $379E, $0A2E, $DEBF, $7198, $28DA, $0484
VSARLAVDCHECK: dh $0655, $44D1, $0075, $3941, $EF34, $2250, $D294, $0000

VSARH0VACHECK: dh $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
               dh $FFEE, $E25D, $CDE7, $C28B, $37AF, $1C66, $0A36, $0121
               dh $0144, $DA90, $CCE4, $D840, $FCA4, $3A10, $9084, $0000
VSARM1VACHECK: dh $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
               dh $FFDC, $C4BB, $9BCF, $8517, $6F5F, $38CC, $146D, $0242
               dh $0288, $B520, $99C8, $B080, $F948, $7420, $2108, $0000
VSARL2VACHECK: dh $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
               dh $FFCA, $A719, $69B7, $47A3, $A70F, $5532, $1EA3, $0363
               dh $03CC, $8FB0, $66AC, $88C0, $F5EC, $AE30, $B18C, $0000

VSARH8VACHECK: dh $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
               dh $FFC9, $A718, $69B6, $47A2, $A70F, $5532, $1EA3, $0363
               dh $03CD, $8FB1, $66AD, $88C1, $F5EC, $AE30, $B18C, $0000
VSARM9VACHECK: dh $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
               dh $FFB7, $8976, $379E, $0A2E, $DEBF, $7198, $28DA, $0484
               dh $0511, $6A41, $3391, $6101, $F290, $E840, $4210, $0000
VSARLAVACHECK: dh $FFFF, $FFFF, $FFFF, $FFFE, $0001, $0000, $0000, $0000
...
VSARH0VCOVCCCHECK: dh $0000, $0000
VSARM1VCOVCCCHECK: dh $0000, $0000
VSARL2VCOVCCCHECK: dh $0000, $0000

VSARH8VCOVCCCHECK: dh $0000, $0000
VSARM9VCOVCCCHECK: dh $0000, $0000
VSARLAVCOVCCCHECK: dh $0000, $0000

VCOVCCWORD: dh $0000, $0000

VSARH0VCECHECK: db $00
VSARM1VCECHECK: db $00
VSARL2VCECHECK: db $00

VSARH8VCECHECK: db $00
VSARM9VCECHECK: db $00
VSARLAVCECHECK: db $00
...
RSPVSARH0Code:
  ...
  vmadn v02,v01,v01,(e0) ; V2 += (V1 * V1[0]), Vector Multiply Accumulate Mid Partial Products: VMADN VD,VS,VT[ELEMENT] (Fill Vector Accumulator HI,MD,LO)
  vsar v02,v00,v01,(e0) ; V2 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v02,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V2, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
...
RSPVSARM1Code:
  ...
  lqv v01,(e0),$01,(0)  ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmadn v02,v01,v01,(e0) ; V2 += (V1 * V1[0]), Vector Multiply Accumulate Mid Partial Products: VMADN VD,VS,VT[ELEMENT] (Fill Vector Accumulator HI,MD,LO)
  vsar v02,v00,v01,(e1) ; V2 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v02,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V2, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
...
RSPVSARL2Code:
  ...
  lqv v01,(e0),$01,(0)  ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmadn v02,v01,v01,(e0) ; V2 += (V1 * V1[0]), Vector Multiply Accumulate Mid Partial Products: VMADN VD,VS,VT[ELEMENT] (Fill Vector Accumulator HI,MD,LO)
  vsar v02,v00,v01,(e2) ; V2 = Vector Accumulator LO, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v02,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V2, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
...
RSPVSARH8Code:
  ...
  lqv v01,(e0),$01,(0)  ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmadn v02,v01,v01,(e0) ; V2 += (V1 * V1[0]), Vector Multiply Accumulate Mid Partial Products: VMADN VD,VS,VT[ELEMENT] (Fill Vector Accumulator HI,MD,LO)
  vsar v02,v00,v01,(e8) ; V2 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v02,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V2, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
...
RSPVSARM9Code:
  ...
  lqv v01,(e0),$01,(0)  ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmadn v02,v01,v01,(e0) ; V2 += (V1 * V1[0]), Vector Multiply Accumulate Mid Partial Products: VMADN VD,VS,VT[ELEMENT] (Fill Vector Accumulator HI,MD,LO)
  vsar v02,v00,v01,(e9) ; V2 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v02,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V2, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
...
RSPVSARLACode:
  ...
  lqv v01,(e0),$01,(0)   ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmadn v02,v01,v01,(e0) ; V2 += (V1 * V1[0]), Vector Multiply Accumulate Mid Partial Products: VMADN VD,VS,VT[ELEMENT] (Fill Vector Accumulator HI,MD,LO)
  vsar v02,v00,v01,(e10) ; V2 = Vector Accumulator LO, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v02,(e0),$00,(0)   ; 128-Bit DMEM $000(R0) = V2, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
