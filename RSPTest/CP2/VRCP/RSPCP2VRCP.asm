...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VRCPTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VRSQTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
...
VRCPVDCHECKA:
  dw $8400, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VRCPVDCHECKB:
  dw $8400, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VRCPVDCHECKC:
  dw $8FFF, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VRCPVDCHECKD:
  dw $8FFF, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VRSQVDCHECKA:
  dw $6000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VRSQVDCHECKB:
  dw $6000, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VRSQVDCHECKC:
  dw $8FFF, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VRSQVDCHECKD:
  dw $8FFF, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
...
align(8) // Align 64-Bit
base RSPVRCPCode+pc() // Set End Of RSP Code Object
RSPVRCPCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVRSQCode+pc() // Set End Of RSP Code Object
RSPVRSQCodeEnd:
