...
ClearScreen:
  ...
  DMASPRD RSPVRCPCode, RSPVRCPCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVRSQCode, RSPVRSQCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
