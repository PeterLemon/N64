...
ClearScreen:
  ...
  DMASPRD RSPVXORCode, RSPVXORCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVNXORCode, RSPVNXORCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
