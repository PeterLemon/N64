...
ClearScreen:
  ...
  la a0,VANDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VANDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VANDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VANDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNANDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNANDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNANDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNANDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
...
VANDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VANDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VANDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VANDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNANDCHECKA: dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VNANDCHECKB: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VNANDCHECKC: dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VNANDCHECKD: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
...
RSPVNANDCode:
  ...
  lqv v00,(e0),$00,(0) ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0) ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vnand v00,v00,v01,(e0) ; V0 = V0 + V1[0], Vector Logical NOT AND Short Elements With Carry: VNAND VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0) ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  break $0000 ; Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
  objend ; Set End Of RSP Code Object
RSPVNANDCodeEND: