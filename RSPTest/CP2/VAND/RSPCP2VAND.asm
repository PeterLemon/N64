...
ClearScreen:
  ...
  DMASPRD(RSPVANDCode, RSPVANDCodeEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  PrintString($A0100000,0,24,FontRed,VANDTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPVNANDCode, RSPVNANDCodeEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  PrintString($A0100000,0,216,FontRed,VNANDTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vand v0,v1[e0] // V0 = V0 & V1[0], Vector Logical AND Short Elements: VAND VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVANDCode+pc() // Set End Of RSP Code Object
RSPVANDCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vnand v0,v1[e0] // V0 = !(V0 & V1[0]), Vector Logical NOT AND Short Elements: VNAND VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVNANDCode+pc() // Set End Of RSP Code Object
RSPVNANDCodeEnd:
