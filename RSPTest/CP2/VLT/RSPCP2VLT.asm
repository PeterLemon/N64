...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VLTTEXT,2) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VGETEXT,2) // Print Text String To VRAM Using Font At X,Y Position
...
VLTVDCHECKA:
  dw $0000, $0000, $0000, $0000, $8899, $AABB, $CCDD, $EEFF
VLTVDCHECKB:
  dw $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VLTVDCHECKC:
  dw $FFEE, $DDCC, $BBAA, $9988, $8899, $AABB, $CCDD, $EEFF
VLTVDCHECKD:
  dw $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VGEVDCHECKA:
  dw $0011, $2233, $4455, $6677, $0000, $0000, $0000, $0000
VGEVDCHECKB:
  dw $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VGEVDCHECKC:
  dw $0011, $2233, $4455, $6677, $7766, $5544, $3322, $1100
VGEVDCHECKD:
  dw $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vlt v0,v1[e0] // V0 = (V0 < V1[0]), Vector Select Less Than: VLT VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVLTCode+pc() // Set End Of RSP Code Object
RSPVLTCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vge v0,v1[e0] // V0 = (V0 >= V1[0]), Vector Select Greater Than Or Equal: VGE VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVGECode+pc() // Set End Of RSP Code Object
RSPVGECodeEnd:
