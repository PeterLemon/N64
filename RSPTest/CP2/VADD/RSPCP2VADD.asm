...
ClearScreen:
  ...
  la a0,VADDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VADDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VADDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VADDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VADDCCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VADDCCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VADDCCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VADDCCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
...
VADDCHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VADDCHECKB: dh $0022, $4466, $7FFF, $7FFF, $8000, $8000, $99BA, $DDFE
VADDCHECKC: dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VADDCHECKD: dh $FFDC, $BB98, $8000, $8000, $7FFF, $7FFF, $6644, $2200

VADDCCHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VADDCCHECKB: dh $0022, $4466, $88AA, $CCEE, $1132, $5576, $99BA, $DDFE
VADDCCHECKC: dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VADDCCHECKD: dh $FFDC, $BB98, $7754, $3310, $EECC, $AA88, $6644, $2200
