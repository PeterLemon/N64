...
ClearScreen:
  ...
  PrintString $A010,8,24,FontRed,VEQTEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString $A010,8,216,FontRed,VNETEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
...
VEQVACHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQVACHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQVACHECKC: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VEQVACHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNEVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNEVACHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNEVACHECKC: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNEVACHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
