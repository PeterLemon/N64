; N64 'Bare Metal' RSP CP2 Vector Select Equal Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPVEQCode, RSPVEQCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,VEQTEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VEQVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VEQVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VEQVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VEQFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VEQVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VEQVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VEQVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VEQVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VEQVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VEQFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VEQVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VEQFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VEQVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VEQVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VEQVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VEQVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VEQFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VEQVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VEQFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VEQVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VEQVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VEQVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VEQFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VEQVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VEQFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VEQVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VEQFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVNECode, RSPVNECodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,VNETEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VNEVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VNEFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VNEVCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VNEFAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VNEVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VNEFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VNEVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VNEFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VNEVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VNEFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VNEVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VNEFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VNEVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VNEVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VNEFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VNEVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VNEFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VNEVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VNEFAILD ; Compare Result Equality With Check Data
...
VEQVDCHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQVDCHECKC: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VEQVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNEVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNEVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNEVDCHECKC: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNEVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VEQVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VEQVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNEVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNEVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNEVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNEVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
...
VEQVCOVCCCHECKA: dh $0000, $0000
VEQVCOVCCCHECKB: dh $0000, $00FF
VEQVCOVCCCHECKC: dh $0000, $0000
VEQVCOVCCCHECKD: dh $0000, $00FF

VNEVCOVCCCHECKA: dh $0000, $00FF
VNEVCOVCCCHECKB: dh $0000, $0000
VNEVCOVCCCHECKC: dh $0000, $00FF
VNEVCOVCCCHECKD: dh $0000, $0000
...
RSPVEQCode:
  ...
  veq v00,v00,v01,(e0) ; V0 = (V0 == V1[0]), Vector Select Equal: VEQ VD,VS,VT[ELEMENT]
...
RSPVNECode:
  ...
  lqv v00,(e0),$00,(0) ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0) ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vne v00,v00,v01,(e0) ; V0 = (V0 != V1), Vector Select Not Equal: VNE VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0) ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
