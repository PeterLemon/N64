...
ClearScreen:
  ...
  DMASPRD RSPVEQCode, RSPVEQCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVNECode, RSPVNECodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
