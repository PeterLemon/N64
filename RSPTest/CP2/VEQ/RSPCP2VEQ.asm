...
ClearScreen:
  ...
  la a0,VEQCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VEQCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VEQCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VEQCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VNECHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VNECHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VNECHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VNECHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
...
VEQCHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEQCHECKC: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VEQCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNECHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNECHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNECHECKC: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNECHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
