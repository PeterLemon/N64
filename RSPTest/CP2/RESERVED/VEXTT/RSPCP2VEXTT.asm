; N64 'Bare Metal' RSP CP2 Vector Triple (5/5/5/1) Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPVEXTTCode, RSPVEXTTCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,VEXTTTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VEXTTVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VEXTTVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VEXTTVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VEXTTFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VEXTTVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VEXTTVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VEXTTVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VEXTTVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VEXTTVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VEXTTFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VEXTTVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VEXTTFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VEXTTVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VEXTTVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VEXTTVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VEXTTVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VEXTTFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VEXTTVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VEXTTFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VEXTTVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VEXTTVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VEXTTVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VEXTTFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VEXTTVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VEXTTFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VEXTTVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VEXTTFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVINSTCode, RSPVINSTCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,VINSTTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VINSTVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VINSTFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VINSTVCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VINSTFAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VINSTVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VINSTFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VINSTVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VINSTFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VINSTVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VINSTFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VINSTVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VINSTFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VINSTVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VINSTVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VINSTFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VINSTVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VINSTFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VINSTVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VINSTFAILD ; Compare Result Equality With Check Data
...
VEXTTVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VEXTTVDCHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VEXTTVDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VEXTTVDCHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

VINSTVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VINSTVDCHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VINSTVDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VINSTVDCHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

VEXTTVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VEXTTVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0022, $4466, $88AA, $CCEE, $1132, $5576, $99BA, $DDFE
VEXTTVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VEXTTVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $FFDC, $BB98, $7754, $3310, $EECC, $AA88, $6644, $2200

VINSTVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VINSTVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0022, $4466, $88AA, $CCEE, $1132, $5576, $99BA, $DDFE
VINSTVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VINSTVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $FFDC, $BB98, $7754, $3310, $EECC, $AA88, $6644, $2200
...
VEXTTVCOVCCCHECKA: dh $0000, $0000
VEXTTVCOVCCCHECKB: dh $0000, $0000
VEXTTVCOVCCCHECKC: dh $0000, $0000
VEXTTVCOVCCCHECKD: dh $0000, $0000

VINSTVCOVCCCHECKA: dh $0000, $0000
VINSTVCOVCCCHECKB: dh $0000, $0000
VINSTVCOVCCCHECKC: dh $0000, $0000
VINSTVCOVCCCHECKD: dh $0000, $0000

VCOVCCWORD: dh $0000, $0000

VEXTTVCECHECKA: db $00
VEXTTVCECHECKB: db $00
VEXTTVCECHECKC: db $00
VEXTTVCECHECKD: db $00

VINSTVCECHECKA: db $00
VINSTVCECHECKB: db $00
VINSTVCECHECKC: db $00
VINSTVCECHECKD: db $00
...
RSPVEXTTCode:
  ...
  vextt v00,v00,v01,(e0) ; V0 = V0 EXTT V1[0], Vector Extract Triple (5/5/5/1): VEXTT VD,VS,VT[ELEMENT]
...
RSPVINSTCode:
  ...
  lqv v00,(e0),$00,(0)   ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0)   ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vinst v00,v00,v01,(e0) ; V0 = V0 INST V1[0], Vector Insert Triple (5/5/5/1): VINST VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0)   ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
