...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VEXTTTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VINSTTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VEXTTVACHECKB:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0022, $4466, $88AA, $CCEE, $1132, $5576, $99BA, $DDFE
VEXTTVACHECKC:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
...
VEXTTVACHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $FFDC, $BB98, $7754, $3310, $EECC, $AA88, $6644, $2200

VINSTVACHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $FFCA, $9964, $32FE, $CC98, $6632, $FFCC, $9966, $3300
VINSTVACHECKB:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $FFDB, $BB97, $7753, $330F, $EECB, $AA87, $6643, $21FF
VINSTVACHECKC:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $FFEC, $DDCA, $BBA8, $9986, $7764, $5542, $3320, $10FE
VINSTVACHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $FFDA, $BB96, $7752, $330E, $EECA, $AA86, $6642, $21FE
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vextt v0,v1[e0] // V0 = V0 EXTT V1[0], Vector Extract Triple (5/5/5/1): VEXTT VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVEXTTCode+pc() // Set End Of RSP Code Object
RSPVEXTTCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vinst v0,v1[e0] // V0 = V0 INST V1[0], Vector Insert Triple (5/5/5/1): VINST VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVINSTCode+pc() // Set End Of RSP Code Object
RSPVINSTCodeEnd:
