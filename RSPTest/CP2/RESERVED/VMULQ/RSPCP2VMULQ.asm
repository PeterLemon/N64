...
ClearScreen:
  ...
  DMASPRD RSPVMULQCode, RSPVMULQCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,VMULQTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VMULQVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMULQVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VMULQVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMULQFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMULQVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMULQVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VMULQVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMULQVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VMULQVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMULQFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMULQVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VMULQFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMULQVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VMULQVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMULQVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VMULQVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMULQFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMULQVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VMULQFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMULQVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VMULQVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMULQVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMULQFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VMULQVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMULQFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMULQVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VMULQFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVMACQCode, RSPVMACQCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,VMACQTEXT,4 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VMACQVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMACQFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMACQVCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VMACQFAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VMACQVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMACQFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMACQVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VMACQFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VMACQVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMACQFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMACQVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VMACQFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD        ; A0 = Quad Data Offset
  ld t0,8(a0)         ; T0 = Quad Data
  la a0,VMACQVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ld t0,0(a0)         ; T0 = Quad Data
  la a0,VMACQVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)         ; T1 = Quad Check Data
  bne t0,t1,VMACQFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD        ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD        ; A0 = Word Data Offset
  lw t0,0(a0)             ; T0 = Word Data
  la a0,VMACQVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)             ; T1 = Word Check Data
  bne t0,t1,VMACQFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE        ; A0 = Byte Data Offset
  lb t0,0(a0)          ; T0 = Byte Data
  la a0,VMACQVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)          ; T1 = Byte Check Data
  bne t0,t1,VMACQFAILD ; Compare Result Equality With Check Data
...
VMULQVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMULQVDCHECKB: dh $0090, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0
VMULQVDCHECKC: dh $FF70, $8000, $8000, $8000, $8000, $8000, $8000, $8000
VMULQVDCHECKD: dh $00A0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0

VMACQVDCHECKA: dh $0090, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0
VMACQVDCHECKB: dh $0090, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0
VMACQVDCHECKC: dh $0090, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0
VMACQVDCHECKD: dh $0090, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0

VMULQVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMULQVACHECKB: dh $0000, $0491, $123D, $2903, $37B0, $1C66, $0A36, $0121
               dh $0121, $9629, $4439, $0B51, $EB71, $E499, $F6C9, $2201
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMULQVACHECKC: dh $FFFF, $FB6E, $EDC2, $D6FC, $C84F, $E399, $F5C9, $FEDE
               dh $FEED, $47C3, $7791, $8E57, $8C15, $70CB, $3C79, $EF1F
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMULQVACHECKD: dh $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0121
               dh $0144, $DA90, $CCE4, $D840, $FCA4, $3A10, $9084, $0000
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

VMACQVACHECKA: dh $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0120
               dh $0124, $DA70, $CCE4, $D820, $FCA4, $39F0, $9064, $FFE0
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMACQVACHECKB: dh $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0120
               dh $0124, $DA70, $CCE4, $D820, $FCA4, $39F0, $9064, $FFE0
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMACQVACHECKC: dh $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0120
               dh $0124, $DA70, $CCE4, $D820, $FCA4, $39F0, $9064, $FFE0
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMACQVACHECKD: dh $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0120
               dh $0124, $DA70, $CCE4, $D820, $FCA4, $39F0, $9064, $FFE0
               dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
...
VMULQVCOVCCCHECKA: dh $0000, $0000
VMULQVCOVCCCHECKB: dh $0000, $0000
VMULQVCOVCCCHECKC: dh $0000, $0000
VMULQVCOVCCCHECKD: dh $0000, $0000

VMACQVCOVCCCHECKA: dh $0000, $0000
VMACQVCOVCCCHECKB: dh $0000, $0000
VMACQVCOVCCCHECKC: dh $0000, $0000
VMACQVCOVCCCHECKD: dh $0000, $0000

VCOVCCWORD: dh $0000, $0000

VMULQVCECHECKA: db $00
VMULQVCECHECKB: db $00
VMULQVCECHECKC: db $00
VMULQVCECHECKD: db $00

VMACQVCECHECKA: db $00
VMACQVCECHECKB: db $00
VMACQVCECHECKC: db $00
VMACQVCECHECKD: db $00
...
RSPVMULQCode:
  ...
  vmulq v00,v00,v01,(e0) ; V0 = V0 * V1[0], Vector Multiply Integer: VMULQ VD,VS,VT[ELEMENT]
...
RSPVMACQCode:
  ...
  lqv v00,(e0),$00,(0)   ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0)   ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmacq v00,v00,v01,(e0) ; V0 += (V0 * V1[0]), Vector Multiply Accumulate Integer: VMACQ VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0)   ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
