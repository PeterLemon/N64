...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VMULQTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VMACQTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VMULQVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMULQVDCHECKB:
  dw $0090, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0
VMULQVDCHECKC:
  dw $FF70, $8000, $8000, $8000, $8000, $8000, $8000, $8000
VMULQVDCHECKD:
  dw $00A0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0, $7FF0
...
VMULQVACHECKC:
  ...
  dw $FEED, $47C3, $7791, $8E57, $8C15, $70CB, $3C79, $EF1F
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMULQVACHECKD:
...
VMACQVACHECKA:
  dw $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0120
  dw $0124, $DA70, $CCE4, $D820, $FCA4, $39F0, $9064, $FFE0
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMACQVACHECKB:
  dw $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0120
  dw $0124, $DA70, $CCE4, $D820, $FCA4, $39F0, $9064, $FFE0
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vmulq v0,v1[e0] // V0 = V0 * V1[0], Vector Multiply Integer: VMULQ VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVMULQCode+pc() // Set End Of RSP Code Object
RSPVMULQCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmacq v0,v1[e0] // V0 += (V0 * V1[0]), Vector Multiply Accumulate Integer: VMACQ VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVMACQCode+pc() // Set End Of RSP Code Object
RSPVMACQCodeEnd:
