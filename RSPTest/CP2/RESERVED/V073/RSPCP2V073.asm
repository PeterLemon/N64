...
ClearScreen:
  ...
  DMASPRD(RSPV073Code, RSPV073CodeEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  PrintString($A0100000,0,24,FontRed,V073TEXT,3) // Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,V073VDCHECKA // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILA // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ...
  ld t0,0(a0)        // T0 = Quad Data
  la a0,V073VACHECKA // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILA // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,V073VCOVCCCHECKA // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,V073FAILA // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,V073VCECHECKA // A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,V073VDCHECKB // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILB // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,8(a0)        // T0 = Quad Data
  la a0,V073VDCHECKB // A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,V073VACHECKB // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILB // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       // A0 = Word Data Offset
  lw t0,0(a0)            // T0 = Word Data
  la a0,V073VCOVCCCHECKB // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,V073FAILB // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,V073VCECHECKB // A0 = Byte Check Data Offset
  lb t1,0(a0)         // T1 = Byte Check Data
  bne t0,t1,V073FAILB // Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,V073VDCHECKC // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILC // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,8(a0)        // T0 = Quad Data
  la a0,V073VDCHECKC // A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,V073VACHECKC // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILC // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       // A0 = Word Data Offset
  lw t0,0(a0)            // T0 = Word Data
  la a0,V073VCOVCCCHECKC // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,V073FAILC // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,V073VCECHECKC // A0 = Byte Check Data Offset
  lb t1,0(a0)         // T1 = Byte Check Data
  bne t0,t1,V073FAILC // Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,V073VDCHECKD // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILD // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,8(a0)        // T0 = Quad Data
  la a0,V073VDCHECKD // A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,V073VACHECKD // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,V073FAILD // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       // A0 = Word Data Offset
  lw t0,0(a0)            // T0 = Word Data
  la a0,V073VCOVCCCHECKD // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,V073FAILD // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,V073VCECHECKD // A0 = Byte Check Data Offset
  lb t1,0(a0)         // T1 = Byte Check Data
  bne t0,t1,V073FAILD // Compare Result Equality With Check Data
  ...
  PrintString($A0100000,0,216,FontRed,VNULLTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  v073 v0,v1[e0] // V0 = V0 V073 V1[0], Vector Row 7 Column 3: V073 VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPV073Code+pc() // Set End Of RSP Code Object
RSPV073CodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVNULLCode+pc() // Set End Of RSP Code Object
RSPVNULLCodeEnd:
