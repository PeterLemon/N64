; N64 'Bare Metal' RSP CP2 Vector SAC/SUM Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPVSACCode, RSPVSACCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,VSACTEXT,3 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VSACVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSACVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VSACVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSACFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSACVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSACVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VSACVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSACVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VSACVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSACFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSACVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VSACFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSACVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VSACVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSACVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VSACVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSACFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSACVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VSACFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSACVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VSACVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSACVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSACFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VSACVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSACFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSACVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VSACFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVSUMCode, RSPVSUMCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,VSUMTEXT,3 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VSUMVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSUMFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSUMVCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VSUMFAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VSUMVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSUMFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSUMVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VSUMFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VSUMVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSUMFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSUMVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VSUMFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VSUMVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VSUMVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VSUMFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VSUMVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VSUMFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VSUMVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VSUMFAILD ; Compare Result Equality With Check Data
...
VSACVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSACVDCHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSACVDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSACVDCHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

VSUMVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSUMVDCHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSUMVDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VSUMVDCHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

VSACVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VSACVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0022, $4466, $88AA, $CCEE, $1132, $5576, $99BA, $DDFE
VSACVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VSACVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFDC, $BB98, $7754, $3310, $EECC, $AA88, $6644, $2200

VSUMVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFCA, $9964, $32FE, $CC98, $6632, $FFCC, $9966, $3300
VSUMVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFDB, $BB97, $7753, $330F, $EECB, $AA87, $6643, $21FF
VSUMVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFEC, $DDCA, $BBA8, $9986, $7764, $5542, $3320, $10FE
VSUMVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
...
VSACVCOVCCCHECKA: dh $0000, $0000
VSACVCOVCCCHECKB: dh $0000, $0000
VSACVCOVCCCHECKC: dh $0000, $0000
VSACVCOVCCCHECKD: dh $0000, $0000

VSUMVCOVCCCHECKA: dh $0000, $0000
VSUMVCOVCCCHECKB: dh $0000, $0000
VSUMVCOVCCCHECKC: dh $0000, $0000
VSUMVCOVCCCHECKD: dh $0000, $0000
...
RSPVSACCode:
  ...
  vsac v00,v00,v01,(e0) ; V0 = V0 VSAC V1[0], Vector SAC: VSAC VD,VS,VT[ELEMENT]
...
RSPVSUMCode:
  ...
  lqv v00,(e0),$00,(0)  ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0)  ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vsum v00,v00,v01,(e0) ; V0 = V0 VSUM V1[0], Vector SUM: VSUM VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
