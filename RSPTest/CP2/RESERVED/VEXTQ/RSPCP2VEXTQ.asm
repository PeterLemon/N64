...
ClearScreen:
  ...
  DMASPRD RSPVEXTQCode, RSPVEXTQCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVINSQCode, RSPVINSQCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
