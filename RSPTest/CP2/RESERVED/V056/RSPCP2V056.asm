; N64 'Bare Metal' RSP CP2 Vector 056,057 Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPV056Code, RSPV056CodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,V056TEXT,3 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,V056VDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V056VACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,V056VCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V056FAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V056VCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V056VDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,V056VDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V056VACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,V056VCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V056FAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V056VCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,V056FAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V056VDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,V056VDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V056VACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,V056VCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V056FAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V056VCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,V056FAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V056VDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,V056VDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V056VACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V056FAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,V056VCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V056FAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V056VCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,V056FAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPV057Code, RSPV057CodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,V057TEXT,3 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,V057VCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V057FAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V057VCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,V057FAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,V057VCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V057FAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V057VCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,V057FAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,V057VCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V057FAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V057VCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,V057FAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,V057VDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,V057VACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,V057FAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,V057VCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,V057FAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,V057VCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,V057FAILD ; Compare Result Equality With Check Data
...
V056VDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
V056VDCHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
V056VDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
V056VDCHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

V057VDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
V057VDCHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
V057VDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
V057VDCHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

V056VACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
V056VACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0022, $4466, $88AA, $CCEE, $1132, $5576, $99BA, $DDFE
V056VACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
V056VACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFDC, $BB98, $7754, $3310, $EECC, $AA88, $6644, $2200

V057VACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
V057VACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0022, $4466, $88AA, $CCEE, $1132, $5576, $99BA, $DDFE
V057VACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
V057VACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFDC, $BB98, $7754, $3310, $EECC, $AA88, $6644, $2200
...
V056VCOVCCCHECKA: dh $0000, $0000
V056VCOVCCCHECKB: dh $0000, $0000
V056VCOVCCCHECKC: dh $0000, $0000
V056VCOVCCCHECKD: dh $0000, $0000

V057VCOVCCCHECKA: dh $0000, $0000
V057VCOVCCCHECKB: dh $0000, $0000
V057VCOVCCCHECKC: dh $0000, $0000
V057VCOVCCCHECKD: dh $0000, $0000
...
RSPV056Code:
  ...
  v056 v00,v00,v01,(e0) ; V0 = V0 V056 V1[0], Vector Row 5 Column 6: V056 VD,VS,VT[ELEMENT]
...
RSPV057Code:
  ...
  lqv v00,(e0),$00,(0)  ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0)  ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  v057 v00,v00,v01,(e0) ; V0 = V0 V057 V1[0], Vector Row 5 Column 7: V057 VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
