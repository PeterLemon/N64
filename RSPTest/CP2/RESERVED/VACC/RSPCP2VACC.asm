// N64 'Bare Metal' RSP CP2 Vector Add, Subtract Elements With Carry Test Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "RSPCP2VACC.N64", create
...
ClearScreen:
  ...
  DMASPRD(RSPVACCCode, RSPVACCCodeEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  PrintString($A0100000,0,24,FontRed,VACCTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
  ...
  // Load RSP Code To IMEM
  DMASPRD(RSPVSUCCode, RSPVSUCCodeEnd, SP_IMEM) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  PrintString($A0100000,0,216,FontRed,VSUCTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKA // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILA // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,8(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKA // A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVACHECKA // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILA // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       // A0 = Word Data Offset
  lw t0,0(a0)            // T0 = Word Data
  la a0,VSUCVCOVCCCHECKA // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,VSUCFAILA // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,VSUCVCECHECKA // A0 = Byte Check Data Offset
  lb t1,0(a0)         // T1 = Byte Check Data
  bne t0,t1,VSUCFAILA // Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKB // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILB // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,8(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKB // A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVACHECKB // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILB // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       // A0 = Word Data Offset
  lw t0,0(a0)            // T0 = Word Data
  la a0,VSUCVCOVCCCHECKB // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,VSUCFAILB // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,VSUCVCECHECKB // A0 = Byte Check Data Offset
  lb t1,0(a0)         // T1 = Byte Check Data
  bne t0,t1,VSUCFAILB // Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKC // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILC // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,8(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKC // A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVACHECKC // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILC // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       // A0 = Word Data Offset
  lw t0,0(a0)            // T0 = Word Data
  la a0,VSUCVCOVCCCHECKC // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,VSUCFAILC // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,VSUCVCECHECKC // A0 = Byte Check Data Offset
  lb t1,0(a0)         // T1 = Byte Check Data
  bne t0,t1,VSUCFAILC // Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKD // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILD // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VDQUAD       // A0 = Quad Data Offset
  ld t0,8(a0)        // T0 = Quad Data
  la a0,VSUCVDCHECKD // A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       // A0 = Quad Data Offset
  ld t0,0(a0)        // T0 = Quad Data
  la a0,VSUCVACHECKD // A0 = Quad Check Data Offset
  ld t1,0(a0)        // T1 = Quad Check Data
  bne t0,t1,VSUCFAILD // Compare Result Equality With Check Data
  nop // Delay Slot
  la a0,VAQUAD       // A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       // A0 = Word Data Offset
  lw t0,0(a0)            // T0 = Word Data
  la a0,VSUCVCOVCCCHECKD // A0 = Word Check Data Offset
  lw t1,0(a0)            // T1 = Word Check Data
  bne t0,t1,VSUCFAILD // Compare Result Equality With Check Data

  la a0,VCEBYTE       // A0 = Byte Data Offset
  lb t0,0(a0)         // T0 = Byte Data
  la a0,VSUCVCECHECKD // A0 = Byte Check Data Offset
  lb t1,0(a0)         // T1 = Byte Check Data
  bne t0,t1,VSUCFAILD // Compare Result Equality With Check Data
...
VACCVACHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0010, $2232, $4454, $6676, $8898, $AABA, $CCDC, $EEFE
...
VSUCVACHECKC:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0020, $4464, $88A8, $CCEC, $1130, $5574, $99B8, $DDFC
VSUCVACHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $000E, $2230, $4452, $6674, $8896, $AAB8, $CCDA, $EEFC
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vacc v0,v1[e0] // V0 = V0 + V1[0], Vector Add Elements With Carry: VACC VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVACCCode+pc() // Set End Of RSP Code Object
RSPVACCCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vsuc v0,v1[e0] // V0 = V0 - V1[0], Vector Subtract Elements With Carry: VSUC VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVSUCCode+pc() // Set End Of RSP Code Object
RSPVSUCCodeEnd:
