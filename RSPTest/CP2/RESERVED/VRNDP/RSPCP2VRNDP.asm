...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VRNDPTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VRNDNTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VRNDNVDCHECKA:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
VRNDNVDCHECKB:
  dw $0000, $0000, $0000, $0000, $FFFE, $FFFF, $FFFF, $FFFF
VRNDNVDCHECKC:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
VRNDNVDCHECKD:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
...
VRNDPVACHECKB:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0022, $4466, $88AA, $CCEE, $8899, $AABB, $CCDD, $EEFF
VRNDPVACHECKC:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0010, $2232, $4454, $6676, $8899, $AABB, $CCDD, $EEFF
VRNDPVACHECKD:
  dw $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
  dw $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
  dw $FFFE, $FFFE, $FFFE, $FFFE, $8899, $AABB, $CCDD, $EEFF

VRNDNVACHECKA:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $000F, $2231, $4453, $6675, $1132, $5576, $99BA, $DDFE
VRNDNVACHECKB:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $0000, $0000, $0000, $FFFE, $FFFF, $FFFF, $FFFF
  dw $000F, $2231, $4453, $6675, $99CB, $0031, $6697, $CCFD
VRNDNVACHECKC:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $000F, $2231, $4453, $6675, $1131, $5575, $99B9, $DDFD
VRNDNVACHECKD:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $000F, $2231, $4453, $6675, $8897, $AAB9, $CCDB, $EEFD
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vrndp v0,v1[e0] // V0 = V0 DCTROUNDPOS V1[0], Vector DCT Round Positive: VRNDP VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVRNDPCode+pc() // Set End Of RSP Code Object
RSPVRNDPCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vrndn v0,v1[e0] // V0 = V0 DCTROUNDNEG V1[0], Vector DCT Round Negative: VRNDN VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVRNDNCode+pc() // Set End Of RSP Code Object
RSPVRNDNCodeEnd:
