...
ClearScreen:
  ...
  DMASPRD RSPVSUBBCode, RSPVSUBBCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVSUCBCode, RSPVSUCBCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
