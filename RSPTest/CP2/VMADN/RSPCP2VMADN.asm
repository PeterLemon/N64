...
ClearScreen:
  ...
  DMASPRD RSPVMADNCode, RSPVMADNCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVMADHCode, RSPVMADHCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
