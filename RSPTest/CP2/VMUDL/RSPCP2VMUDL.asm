...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VMUDLTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VMUDMTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VMUDLVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMUDLVDCHECKB:
  dw $0000, $0491, $123D, $2903, $48E2, $71DC, $A3F0, $DF1F
VMUDLVDCHECKC:
  dw $0010, $1DA1, $3217, $3D73, $3FB5, $38DD, $28EB, $0FDE
VMUDLVDCHECKD:
  dw $FFDC, $C029, $8991, $5C13, $37AF, $1C66, $0A36, $0121
...
VMUDMVDCHECKC:
  dw $0010, $1DA1, $3217, $3D73, $C84F, $E399, $F5C9, $FEDE
VMUDMVDCHECKD:
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vmudl v0,v1[e0] // V0 = V0 * V1[0], Vector Multiply Low Partial Products: VMUDL VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVMUDLCode+pc() // Set End Of RSP Code Object
RSPVMUDLCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmudm v0,v1[e0] // V0 = V0 * V1[0], Vector Multiply Mid Partial Products: VMUDM VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVMUDMCode+pc() // Set End Of RSP Code Object
RSPVMUDMCodeEnd:
