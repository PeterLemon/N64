...
ClearScreen:
  ...
  DMASPRD(VALUEQUADC, VALUEQUADCEnd, SP_DMEM+32) // DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  RSPSORTCodeDMABusy:
    ...
    bnez t0,RSPSORTCodeDMABusy // IF TRUE DMA Is Busy
    nop // Delay Slot
