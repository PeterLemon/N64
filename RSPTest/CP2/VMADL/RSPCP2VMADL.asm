...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VMADLTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VMADMTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VMADLVDCHECKC:
  dw $0010, $2232, $4454, $6676, $8897, $AAB9, $CCDB, $EEFD
VMADLVDCHECKD:
  dw $FFEC, $E25B, $CDE5, $C289, $C046, $C71F, $D711, $F01E

VMADMVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMADMVDCHECKB:
  dw $0001, $0492, $123E, $2903, $C04A, $C722, $D714, $F021
VMADMVDCHECKC:
  dw $0011, $2233, $4455, $6677, $889A, $AABC, $CCDE, $EF00
VMADMVDCHECKD:
  dw $0000, $0491, $123D, $2903, $C04A, $C722, $D714, $F021
...
VMADMVACHECKB:
  ...
  dw $0001, $0492, $123E, $2903, $C04A, $C722, $D714, $F021
  dw $010D, $7884, $121E, $CDDA, $ABB7, $ABB8, $CDDA, $121F
VMADMVACHECKC:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0011, $2233, $4455, $6677, $889A, $AABC, $CCDE, $EF00
  dw $FFDB, $C028, $8990, $5C12, $37AD, $1C64, $0A34, $011F
VMADMVACHECKD:
  dw $0000, $0000, $0000, $0000, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $0491, $123D, $2903, $C04A, $C722, $D714, $F021
  dw $011F, $9AB8, $5674, $3452, $3451, $5674, $9AB8, $011F
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vmadl v0,v1[e0] // V0 += (V0 * V1[0]), Vector Multiply Accumulate Low Partial Products: VMADL VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVMADLCode+pc() // Set End Of RSP Code Object
RSPVMADLCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmadm v0,v1[e0] // V0 += (V0 * V1[0]), Vector Multiply Accumulate Mid Partial Products: VMADM VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVMADMCode+pc() // Set End Of RSP Code Object
RSPVMADMCodeEnd:
