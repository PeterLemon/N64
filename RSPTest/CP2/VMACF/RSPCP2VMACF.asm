...
ClearScreen:
  ...
  la a0,VMACFCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VMACFCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VMACFCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VMACFCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VMACUCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VMACUCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VMACUCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VMACUCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
...
VMACFCHECKA: dh $0001, $0004, $0000, $0000, $0000, $0000, $0000, $0000
VMACFCHECKB: dh $0001, $0927, $247A, $5206, $6F61, $38CD, $146D, $0242
VMACFCHECKC: dh $0001, $0003, $FFFF, $FFFF, $0000, $0000, $0000, $0000
VMACFCHECKD: dh $0001, $0927, $247B, $5206, $6F60, $38CD, $146D, $0242

VMACUCHECKA: dh $0001, $0927, $247B, $5206, $6F60, $38CD, $146D, $0242
VMACUCHECKB: dh $0001, $124A, $48F5, $FFFF, $FFFF, $719A, $28DB, $0484
VMACUCHECKC: dh $0001, $0927, $247A, $5206, $6F61, $38CD, $146D, $0242
VMACUCHECKD: dh $0001, $124A, $48F6, $FFFF, $FFFF, $719A, $28DB, $0484
