...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VMACFTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VMACUTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VALUEQUADB:
  dw $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VALUEQUADBEnd:

VALUEQUADC:
  dw $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VALUEQUADCEnd:

VMACFVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMACFVDCHECKB:
  dw $0000, $0923, $247A, $5206, $6F61, $38CD, $146D, $0242
VMACFVDCHECKC:
  dw $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
VMACFVDCHECKD:
  dw $0000, $0923, $247B, $5206, $6F60, $38CD, $146D, $0242

VMACUVDCHECKA:
  dw $0000, $0923, $247B, $5206, $6F60, $38CD, $146D, $0242
VMACUVDCHECKB:
  dw $0000, $1246, $48F5, $FFFF, $FFFF, $719A, $28DB, $0484
VMACUVDCHECKC:
  dw $0000, $0923, $247A, $5206, $6F61, $38CD, $146D, $0242
VMACUVDCHECKD:
  dw $0000, $1246, $48F6, $FFFF, $FFFF, $719A, $28DB, $0484
...
VMACFVACHECKB:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0923, $247A, $5206, $6F61, $38CD, $146D, $0242
  dw $0242, $2C52, $8872, $16A2, $D6E2, $C932, $ED92, $4402
VMACFVACHECKC:
  dw $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
  dw $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
  dw $FFDE, $BB9A, $7756, $3312, $EECE, $AA8A, $6646, $2202
VMACFVACHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0923, $247B, $5206, $6F60, $38CD, $146D, $0242
  dw $0266, $70BA, $111E, $E392, $E816, $1EAA, $874E, $2202
...
VMACUVACHECKB:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $1246, $48F5, $A40C, $DEC2, $719A, $28DB, $0484
  dw $04A8, $9D0C, $9990, $FA34, $BEF8, $E7DC, $74E0, $6604
VMACUVACHECKC:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0923, $247A, $5206, $6F61, $38CD, $146D, $0242
  dw $0244, $2C54, $8874, $16A4, $D6E4, $C934, $ED94, $4404
VMACUVACHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $1246, $48F6, $A40D, $DEC1, $719A, $28DB, $0484
  dw $04CC, $E174, $223C, $C724, $D02C, $3D54, $0E9C, $4404
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vmacf v0,v1[e0] // V0 += (V0 * V1[0]), Vector Multiply Accumulate Signed Fractions: VMACF VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVMACFCode+pc() // Set End Of RSP Code Object
RSPVMACFCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmacu v0,v1[e0] // V0 += (V0 * V1[0]), Vector Multiply Accumulate Unsigned Fractions: VMACU VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVMACUCode+pc() // Set End Of RSP Code Object
RSPVMACUCodeEnd:
