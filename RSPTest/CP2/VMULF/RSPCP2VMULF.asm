...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VMULFTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VMULUTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VMULFVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMULFVDCHECKB:
  dw $0000, $0923, $247B, $5206, $6F62, $38CE, $146E, $0242
VMULFVDCHECKC:
  dw $0000, $F6DD, $DB85, $ADF9, $909F, $C733, $EB92, $FDBE
VMULFVDCHECKD:
  dw $0000, $0924, $247C, $5208, $6F60, $38CC, $146D, $0242
...
VMULFVACHECKB:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0923, $247B, $5206, $6F62, $38CE, $146E, $0242
  dw $8242, $AC52, $0872, $96A2, $56E2, $4932, $6D92, $C402
VMULFVACHECKC:
  dw $0000, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
  dw $0000, $F6DD, $DB85, $ADF9, $909F, $C733, $EB92, $FDBE
  dw $7D9C, $0F48, $6EE4, $9C70, $97EC, $6158, $F8B4, $5E00
VMULFVACHECKD:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
  dw $0000, $0924, $247C, $5208, $6F60, $38CC, $146D, $0242
  dw $8288, $3520, $19C8, $3080, $7948, $F420, $A108, $8000
...
align(8) // Align 64-Bit
base RSPVMULFCode+pc() // Set End Of RSP Code Object
RSPVMULFCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmulu v0,v1[e0] // V0 = V0 * V1[0], Vector Multiply Unsigned Fractions: VMULU VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVMULUCode+pc() // Set End Of RSP Code Object
RSPVMULUCodeEnd:
