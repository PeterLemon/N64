...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VMUDNTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VMUDHTEXT,4) // Print Text String To VRAM Using Font At X,Y Position
...
VMUDNVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMUDNVDCHECKB:
  dw $0121, $9629, $4439, $0B51, $EB71, $E499, $F6C9, $2201
VMUDNVDCHECKC:
  dw $FECE, $47A4, $7772, $8E38, $8BF6, $70AC, $3C5A, $EF00
VMUDNVDCHECKD:
  dw $0144, $DA90, $CCE4, $D840, $FCA4, $3A10, $9084, $0000

VMUDHVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMUDHVDCHECKB:
  dw $0121, $7FFF, $7FFF, $7FFF, $7FFF, $7FFF, $7FFF, $7FFF
VMUDHVDCHECKC:
  dw $FECE, $8000, $8000, $8000, $8000, $8000, $8000, $8000
VMUDHVDCHECKD:
  dw $0144, $7FFF, $7FFF, $7FFF, $7FFF, $7FFF, $7FFF, $7FFF
...
VMUDNVACHECKB:
  ...
  dw $0000, $0491, $123D, $2903, $C049, $C721, $D713, $F020
  dw $0121, $9629, $4439, $0B51, $EB71, $E499, $F6C9, $2201
VMUDNVACHECKC:
  dw $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
  dw $FFFF, $FB6E, $EDC2, $D6FC, $3FB5, $38DD, $28EB, $0FDE
  dw $FECE, $47A4, $7772, $8E38, $8BF6, $70AC, $3C5A, $EF00
VMUDNVACHECKD:
  dw $FFFF, $FFFF, $FFFF, $FFFF, $0000, $0000, $0000, $0000
  dw $FFEE, $E25D, $CDE7, $C28B, $37AF, $1C66, $0A36, $0121
  dw $0144, $DA90, $CCE4, $D840, $FCA4, $3A10, $9084, $0000
...
VMUDHVACHECKA:
  ...
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMUDHVACHECKB:
  dw $0000, $0491, $123D, $2903, $37B0, $1C66, $0A36, $0121
  dw $0121, $9629, $4439, $0B51, $EB71, $E499, $F6C9, $2201
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMUDHVACHECKC:
  dw $FFFF, $FB6E, $EDC2, $D6FC, $C84F, $E399, $F5C9, $FEDE
  dw $FECE, $47A4, $7772, $8E38, $8BF6, $70AC, $3C5A, $EF00
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMUDHVACHECKD:
  dw $0000, $0491, $123D, $2903, $37AF, $1C66, $0A36, $0121
  dw $0144, $DA90, $CCE4, $D840, $FCA4, $3A10, $9084, $0000
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vmudn v0,v1[e0] // V0 = V0 * V1[0], Vector Multiply Mid Partial Products: VMUDN VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVMUDNCode+pc() // Set End Of RSP Code Object
RSPVMUDNCodeEnd:
...
base $0000 // Set Base Of RSP Code Object To Zero
  lqv v0[e0],$00(r0) // V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v1[e0],$01(r0) // V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmudh v0,v1[e0] // V0 = V0 * V1[0], Vector Multiply High Partial Products: VMUDH VD,VS,VT[ELEMENT]
  sqv v0[e0],$00(r0) // 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e8] // V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v0[e0],$01(r0) // 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v0,v0[e9] // V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  ...
  break // Set SP Status Halt, Broke & Check For Interrupt, Set SP Program Counter To $0000
align(8) // Align 64-Bit
base RSPVMUDHCode+pc() // Set End Of RSP Code Object
RSPVMUDHCodeEnd:
