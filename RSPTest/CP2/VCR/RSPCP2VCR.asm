; N64 'Bare Metal' RSP CP2 Vector Select Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPVCRCode, RSPVCRCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,VCRTEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VCRVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCRVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCRVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCRFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCRVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCRVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCRVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCRVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCRVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCRFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCRVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCRFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCRVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCRVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCRVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCRVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCRFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCRVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCRFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCRVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCRVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCRVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCRFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCRVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCRFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCRVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCRFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVMRGCode, RSPVMRGCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,VMRGTEXT,3 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VMRGVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VMRGFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VMRGVCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VMRGFAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VMRGVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VMRGFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VMRGVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VMRGFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VMRGVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VMRGFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VMRGVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VMRGFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VMRGVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VMRGVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VMRGFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VMRGVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VMRGFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VMRGVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VMRGFAILD ; Compare Result Equality With Check Data
...
VCRVDCHECKA: dh $0000, $0000, $0000, $0000, $7766, $5544, $3322, $1100
VCRVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCRVDCHECKC: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCRVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VMRGVDCHECKA: dh $0000, $0000, $0000, $0000, $8899, $AABB, $CCDD, $EEFF
VMRGVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VMRGVDCHECKC: dh $0011, $2233, $4455, $6677, $7766, $5544, $3322, $1100
VMRGVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VCRVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $7766, $5544, $3322, $1100
VCRVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCRVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCRVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VMRGVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $8899, $AABB, $CCDD, $EEFF
VMRGVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VMRGVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0011, $2233, $4455, $6677, $7766, $5544, $3322, $1100
VMRGVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
...
VCRVCOVCCCHECKA: dh $0000, $F0F0
VCRVCOVCCCHECKB: dh $0000, $FFF0
VCRVCOVCCCHECKC: dh $0000, $0FFF
VCRVCOVCCCHECKD: dh $0000, $FF0F

VMRGVCOVCCCHECKA: dh $0000, $FF0F
VMRGVCOVCCCHECKB: dh $0000, $FF0F
VMRGVCOVCCCHECKC: dh $0000, $FF0F
VMRGVCOVCCCHECKD: dh $0000, $FF0F
...
RSPVMRGCode:
  ...
  lqv v00,(e0),$00,(0)  ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0)  ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vmrg v00,v00,v01,(e0) ; V0 = V0 VMRG V1[0], Vector Select Merge: VMRG VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0)  ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
