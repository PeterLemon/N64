...
ClearScreen:
  ...
  la a0,VORCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VORCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VORCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD    ; A0 = Quad Data Offset
  ld t0,0(a0)     ; T0 = Quad Data
  la a0,VORCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)     ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VNORCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VNORCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VNORCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
  ...
  la a0,VDQUAD     ; A0 = Quad Data Offset
  ld t0,0(a0)      ; T0 = Quad Data
  la a0,VNORCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)      ; T1 = Quad Check Data
...
VORCHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VORCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VORCHECKC: dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VORCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNORCHECKA: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VNORCHECKB: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VNORCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNORCHECKD: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
