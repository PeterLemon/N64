; N64 'Bare Metal' RSP CP2 Vector Logical OR Short Elements Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPVORCode, RSPVORCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,8,24,FontRed,VORTEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VORVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VORVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VORVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VORFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VORVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VORVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VORVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VORVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VORVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VORFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VORVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VORFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VORVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VORVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VORVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VORVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VORFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VORVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VORFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VORVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VORVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VORVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VORFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VORVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VORFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VORVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VORFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVNORCode, RSPVNORCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,8,216,FontRed,VNORTEXT,3 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VNORVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNORFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNORVCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VNORFAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VNORVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNORFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNORVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VNORFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VNORVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNORFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNORVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VNORFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VNORVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNORVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNORFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VNORVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNORFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNORVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VNORFAILD ; Compare Result Equality With Check Data
...
VORVDCHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VORVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VORVDCHECKC: dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VORVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNORVDCHECKA: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VNORVDCHECKB: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VNORVDCHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNORVDCHECKD: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF

VORVACHECKA: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VORVACHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VORVACHECKC: dh $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF, $FFFF
VORVACHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VNORVACHECKA: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VNORVACHECKB: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
VNORVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNORVACHECKD: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF

VAQUAD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VDQUAD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000

VORVCOVCCCHECKA: dh $0000, $008F
VORVCOVCCCHECKB: dh $0000, $008F
VORVCOVCCCHECKC: dh $0000, $008F
VORVCOVCCCHECKD: dh $0000, $008F

VNORVCOVCCCHECKA: dh $0000, $008F
VNORVCOVCCCHECKB: dh $0000, $008F
VNORVCOVCCCHECKC: dh $0000, $008F
VNORVCOVCCCHECKD: dh $0000, $008F
...
RSPVORCode:
  ...
  vor v00,v00,v01,(e0) ; V0 = V0 | V1[0], Vector Logical OR Short Elements: VOR VD,VS,VT[ELEMENT]
