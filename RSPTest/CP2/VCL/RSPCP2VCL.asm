; N64 'Bare Metal' RSP CP2 Vector Select Clip Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPVCLCode, RSPVCLCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,24,FontRed,VCLTEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VCLVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCLVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCLVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCLFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCLVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCLVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCLVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCLVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCLVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCLFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCLVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCLFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCLVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCLVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCLVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCLVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCLFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCLVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCLFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCLVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCLVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCLVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCLFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCLVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCLFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCLVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCLFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVCHCode, RSPVCHCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  PrintString $A010,0,216,FontRed,VCHTEXT,2 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKA ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCHVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCHFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCHVCECHECKA ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCHFAILA ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCHVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCHFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCHVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCHFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCHVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCHFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCHVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCHFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD      ; A0 = Quad Data Offset
  ld t0,8(a0)       ; T0 = Quad Data
  la a0,VCHVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ld t0,0(a0)       ; T0 = Quad Data
  la a0,VCHVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)       ; T1 = Quad Check Data
  bne t0,t1,VCHFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD      ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD      ; A0 = Word Data Offset
  lw t0,0(a0)           ; T0 = Word Data
  la a0,VCHVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)           ; T1 = Word Check Data
  bne t0,t1,VCHFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE      ; A0 = Byte Data Offset
  lb t0,0(a0)        ; T0 = Byte Data
  la a0,VCHVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)        ; T1 = Byte Check Data
  bne t0,t1,VCHFAILD ; Compare Result Equality With Check Data
...
VCLVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VCLVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCLVDCHECKC: dh $0011, $2233, $4455, $6677, $7766, $5544, $3322, $1100
VCLVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VCHVDCHECKA: dh $0000, $0000, $0000, $0000, $7767, $5545, $3323, $1101
VCHVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCHVDCHECKC: dh $0012, $2234, $4456, $6678, $889A, $AABC, $CCDE, $EF00
VCHVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VCLVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VCLVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCLVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $7766, $5544, $3322, $1100
VCLVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100

VCHVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $7767, $5545, $3323, $1101
VCHVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VCHVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0012, $2234, $4456, $6678, $889A, $AABC, $CCDE, $EF00
VCHVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
             dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
...
VCLVCOVCCCHECKA: dh $0000, $0000
VCLVCOVCCCHECKB: dh $0000, $FF00
VCLVCOVCCCHECKC: dh $0000, $F000
VCLVCOVCCCHECKD: dh $0000, $FF00

VCHVCOVCCCHECKA: dh $FFF0, $F0F0
VCHVCOVCCCHECKB: dh $0000, $FFF0
VCHVCOVCCCHECKC: dh $00FF, $0FFF
VCHVCOVCCCHECKD: dh $0000, $FF0F
...
RSPVCLCode:
  ...
  vcl v00,v00,v01,(e0) ; V0 = V0 VCL V1[0], Vector Select Clip Test Low: VCL VD,VS,VT[ELEMENT]
...
RSPVCHCode:
  ...
  lqv v00,(e0),$00,(0) ; V0 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  lqv v01,(e0),$01,(0) ; V1 = 128-Bit DMEM $010(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vch v00,v00,v01,(e0) ; V0 = V0 VCH V1[0], Vector Select Clip Test High: VCH VD,VS,VT[ELEMENT]
  sqv v00,(e0),$00,(0) ; 128-Bit DMEM $000(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e8) ; V0 = Vector Accumulator HI, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(0)  ; 128-Bit DMEM $010(R0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
  vsar v00,v00,v00,(e9) ; V0 = Vector Accumulator MD, Vector Accumulator Read: VSAR VD,VS,VT[ELEMENT]
