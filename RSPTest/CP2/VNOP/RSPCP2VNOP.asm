...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VNOPTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
...
align(8) // Align 64-Bit
base RSPVNOPCode+pc() // Set End Of RSP Code Object
RSPVNOPCodeEnd:
