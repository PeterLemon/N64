; N64 'Bare Metal' RSP CP2 Vector Null Instruction Test Demo by krom (Peter Lemon):
...
ClearScreen:
  ...
  DMASPRD RSPVNOPCode, RSPVNOPCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
  ...
  PrintString $A010,0,24,FontRed,VNOPTEXT,3 ; Print Text String To VRAM Using Font At X,Y Position
  ...
  la a0,VNOPVDCHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ...
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNOPVACHECKA ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILA ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VNOPVCOVCCCHECKA ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNOPFAILA ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNOPVCECHECKA ; A0 = Byte Check Data Offset
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNOPVDCHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VNOPVDCHECKB ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNOPVACHECKB ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILB ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VNOPVCOVCCCHECKB ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNOPFAILB ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNOPVCECHECKB ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VNOPFAILB ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNOPVDCHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VNOPVDCHECKC ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNOPVACHECKC ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILC ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VNOPVCOVCCCHECKC ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNOPFAILC ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNOPVCECHECKC ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VNOPFAILC ; Compare Result Equality With Check Data
  ...
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNOPVDCHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VDQUAD       ; A0 = Quad Data Offset
  ld t0,8(a0)        ; T0 = Quad Data
  la a0,VNOPVDCHECKD ; A0 = Quad Check Data Offset
  ...
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ld t0,0(a0)        ; T0 = Quad Data
  la a0,VNOPVACHECKD ; A0 = Quad Check Data Offset
  ld t1,0(a0)        ; T1 = Quad Check Data
  bne t0,t1,VNOPFAILD ; Compare Result Equality With Check Data
  nop ; Delay Slot
  la a0,VAQUAD       ; A0 = Quad Data Offset
  ...
  la a0,VCOVCCWORD       ; A0 = Word Data Offset
  lw t0,0(a0)            ; T0 = Word Data
  la a0,VNOPVCOVCCCHECKD ; A0 = Word Check Data Offset
  lw t1,0(a0)            ; T1 = Word Check Data
  bne t0,t1,VNOPFAILD ; Compare Result Equality With Check Data

  la a0,VCEBYTE       ; A0 = Byte Data Offset
  lb t0,0(a0)         ; T0 = Byte Data
  la a0,VNOPVCECHECKD ; A0 = Byte Check Data Offset
  lb t1,0(a0)         ; T1 = Byte Check Data
  bne t0,t1,VNOPFAILD ; Compare Result Equality With Check Data
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVNULLCode, RSPVNULLCodeEND, SP_IMEM ; DMA Data Read DRAM->RSP MEM: Start Address, End Address, Destination RSP MEM Address
...
VNOPVDCHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNOPVDCHECKB: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNOPVDCHECKC: dh $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VNOPVDCHECKD: dh $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
...
VNOPVACHECKA: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNOPVACHECKB: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNOPVACHECKC: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VNOPVACHECKD: dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
              dh $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
...
VNOPVCOVCCCHECKA: dh $0000, $0000
VNOPVCOVCCCHECKB: dh $0000, $0000
VNOPVCOVCCCHECKC: dh $0000, $0000
VNOPVCOVCCCHECKD: dh $0000, $0000
...
RSPVNOPCode:
  ...
  vnop v00,v00,v01,(e0) ; V0 = V0 VNOP V1[0], Vector Null Instruction: VNOP VD,VS,VT[ELEMENT]
