...
ClearScreen:
  ...
  DMASPRD RSPVRCPLCode, RSPVRCPLCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
  ...
  ; Load RSP Code To IMEM
  DMASPRD RSPVRSQLCode, RSPVRSQLCodeEND, SP_IMEM ; DMA Data Read MEM->RSP DRAM: Start Address, End Address, Destination RSP DRAM Address
