...
ClearScreen:
  ...
  PrintString($A0100000,0,24,FontRed,VABSTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
  ...
  PrintString($A0100000,0,216,FontRed,VMOVTEXT,3) // Print Text String To VRAM Using Font At X,Y Position
...
VABSVDCHECKA:
  dw $0000, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VABSVDCHECKB:
  dw $0011, $2233, $4455, $6677, $7767, $5545, $3323, $1101
VABSVDCHECKC:
  dw $FFEE, $DDCC, $BBAA, $9988, $889A, $AABC, $CCDE, $EF00
VABSVDCHECKD:
  dw $0012, $2234, $4456, $6678, $7766, $5544, $3322, $1100

VMOVVDCHECKA:
  dw $0011, $0000, $0000, $0000, $0000, $0000, $0000, $0000
VMOVVDCHECKB:
  dw $0011, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VMOVVDCHECKC:
  dw $FFEE, $2233, $4455, $6677, $8899, $AABB, $CCDD, $EEFF
VMOVVDCHECKD:
  dw $FFEE, $DDCC, $BBAA, $9988, $7766, $5544, $3322, $1100
...
base $0000 // Set Base Of RSP Code Object To Zero
  ...
  vabs v0,v1[e0] // V0 = V0 VABS V1[0], Vector Absolute Value Of Short Elements: VABS VD,VS,VT[ELEMENT]
...
align(8) // Align 64-Bit
base RSPVABSCode+pc() // Set End Of RSP Code Object
RSPVABSCodeEnd:
