// N64 'Bare Metal' VI Interrupt BG Scrolling 16BPP DMA 320x240 Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "VIScrollingBGDMA16BPP320X240.N64", create
...
Start:
  ...
  la t2,$A0100000+((320*480)-640) // T1 = Origin End (Frame Buffer Origin End In Bytes)
Loop:
  ...
  addiu t1,640        // T1 += 640 (Frame Buffer Origin In Bytes += 1 Scanline) (Delay Slot)
