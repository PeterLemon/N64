...
Start:
  ...
  li t0,2         ; T0 = Status/Control (Pixel Size = 2: 16BPP 5/5/5/1)
  sw t0,0(a0)     ; Store Status/Control To VI Status Register ($A4400000)
  li t0,$A0000000 ; T0 = Origin (Frame Buffer Origin In Bytes = DRAM)
  sw t0,4(a0)     ; Store Origin To VI Origin Register ($A4400004)
  li t0,320       ; T0 = Width (Frame Buffer Line Width In Pixels = 320)
  sw t0,8(a0)     ; Store Width To VI Width Register ($A4400008)
  li t0,$200      ; T0 = Vertical Interrupt (Interrupt When Current Half-Line = $200)
  ...
  li t0,$0000020D ; T0 = Vertical Sync (Number Of Half-Lines Per Field = 525)
  sw t0,24(a0)    ; Store Vertical Sync To VI V Sync Register ($A4400018)
  li t0,$00000C15 ; T0 = Horizontal Sync (5-bit Leap Pattern Used For PAL only = 0, Total Duration Of A Line In 1/4 Pixel = 3093)
  ...
  li t0,$200      ; T0 = X-Scale (Horizontal Subpixel Offset In 2.10 Format = 0, 1/Horizontal Scale Up Factor In 2.10 Format = 512)
  sw t0,48(a0)    ; Store X-Scale To VI X Scale Register ($A4400030)
  li t0,$400      ; T0 = Y-Scale (Vertical Subpixel Offset In 2.10 Format = 0, 1/Vertical Scale Up Factor In 2.10 Format = 1024)
