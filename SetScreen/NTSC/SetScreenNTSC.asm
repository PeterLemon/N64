...
Start:
  ...
  lli t0,$0000020D // T0 = Vertical Sync (Number Of Half-Lines Per Field = 525)
  sw t0,24(a0)     // Store Vertical Sync To VI V Sync Register ($A4400018)
  lli t0,$00000C15 // T0 = Horizontal Sync (5-bit Leap Pattern Used For PAL only = 0, Total Duration Of A Line In 1/4 Pixel = 3093)
