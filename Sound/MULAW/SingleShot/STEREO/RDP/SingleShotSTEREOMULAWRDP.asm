// N64 'Bare Metal' Sound Single Shot Stereo Mu-Law RDP Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "SingleShotSTEREOMULAWRDP.N64", create
...
arch n64.rdp
  ...
  Set_Texture_Image IMAGE_DATA_FORMAT_RGBA,SIZE_OF_PIXEL_16B,1-1, MuLawLUT // Set Texture Image: FORMAT RGBA,SIZE 16B,WIDTH 1, Tlut DRAM ADDRESS
