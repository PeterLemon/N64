...
Start:
  ...
  li t0,7 ; T0 = Sample Bit Rate (Bitrate-1)
...
AIBusy:
  ...
  li t0,(VI_NTSC_CLOCK/(22050/4))-1 ; T0 = Sample Frequency: (VI_NTSC_CLOCK(48681812) / FREQ(22050 / 4)) - 1
  sw t0,AI_DACRATE(a0) ; Store Sample Frequency To AI DAC Rate Reg ($A4500010)
  li t0,123144 ; T0 = Length Of Sample Buffer
  sw t0,AI_LEN(a0) ; Store Length Of Sample Buffer To AI Length Reg ($A4500004)

Loop:
  j Loop
  nop ; Delay Slot

Sample: ; 8-Bit 44100Hz Signed Mono Sound Sample
  incbin Sample.bin