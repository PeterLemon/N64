...
output "Star Wars Episode I - Racer HD.z64", create
origin $00000000; insert "Star Wars Episode I - Racer (U) [!].z64" // Include USA Star Wars Episode I - Racer N64 ROM
origin $00000020
db "STAR WARS EP1 RACER HD     " // $00000020 - PROGRAM TITLE (27 Byte ASCII String, Use Spaces For Unused Bytes)

include "LIB/N64.INC" // Include N64 Definitions

origin $00087088

// Replace burst with loop (Widescreen Streched)
ori t1,r0,3
or t0,a0,r0
loop:
  swc1 f2,0x6c(t0)
...
// Write 3F400000 to 80120F90 (Widescreen Streched)
lui t1,0x3F40
lui t0,0x8012
sw t1,0x0F90(t0)
