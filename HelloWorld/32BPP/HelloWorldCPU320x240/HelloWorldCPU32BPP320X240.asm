...
PrintString: macro vram, xpos, ypos, fontfile, string, length ; Print Text String To VRAM Using Font At X,Y Position
  ...
  addi a0,((xpos*4)+((320*ypos)*4)) ; Place text at XY Position
