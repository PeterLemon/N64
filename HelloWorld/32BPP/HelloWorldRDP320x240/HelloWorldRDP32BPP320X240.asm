// N64 'Bare Metal' 32BPP 320x240 Hello World RDP Cycle 1 Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "HelloWorldRDP32BPP320X240.N64", create
