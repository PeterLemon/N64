...
// Calculate X,Y 2D
  lqv v2[e0],HALF_SCREEN_X>>4(r0) // V2 = Screen X / 2 ($020)
  lqv v3[e0],HALF_SCREEN_Y>>4(r0) // V3 = Screen Y / 2 ($030)
 
  vadd v0,v2[e0] // X = X + (ScreenX / 2)
  vsub v1,v3,v1[e0] // Y = (ScreenY / 2) - Y
...
HALF_SCREEN_X:
  dw 160<<2, 160<<2, 160<<2, 160<<2, 160<<2, 160<<2, 160<<2, 160<<2 // 8 * Screen X / 2 (10.2)
HALF_SCREEN_Y:
  dw 120<<2, 120<<2, 120<<2, 120<<2, 120<<2, 120<<2, 120<<2, 120<<2 // 8 * Screen Y / 2 (10.2)
