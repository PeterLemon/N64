...
RSPCode:
  ...
  lqv v01,(e0),$00,(0) ; V1 = 128-Bit DMEM $000(R0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  li t0,3840-16 ; T0 = 3 Scanlines Quad Count
  li t1,3839 ; T1 = Length Of DMA Transfer In Bytes - 1
  li a1,SP_DMEM+16 ; A1 = SP Memory Address Offset DMEM $010 ($A4000000..$A4001FFF 8KB)
...
LoopVRAM:  
  move a0,r0 ; A0 = 0
LoopScanline:
  lqv v00,(e0),$01,(4) ; V0 = 128-Bit DMEM $010(A0), Load Quad To Vector: LQV VT[ELEMENT],$OFFSET(BASE)
  vsubc v00,v00,v01,(e0) ; V0 = V0 - V1[0], Vector Subtract Short Elements With Carry: VSUBC VD,VS,VT[ELEMENT]
  sqv v00,(e0),$01,(4) ; 128-Bit DMEM $010(A0) = V0, Store Vector To Quad: SQV VT[ELEMENT],$OFFSET(BASE)
