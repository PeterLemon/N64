...
for ctr in range(8):
    ...
    dct_input_1d[ctr*8 + 0] = tmp10 + tmp11
    dct_input_1d[ctr*8 + 4] = tmp10 - tmp11

    z1 = (tmp12 + tmp13) * FIX_0_541196100

    dct_input_1d[ctr*8 + 2] = z1 + (tmp13 * FIX_0_765366865)
    dct_input_1d[ctr*8 + 6] = z1 + (tmp12 * -FIX_1_847759065)
    ...
    dct_input_1d[ctr*8 + 7] = tmp4 + z1 + z3
    dct_input_1d[ctr*8 + 5] = tmp5 + z2 + z4
    dct_input_1d[ctr*8 + 3] = tmp6 + z2 + z3
    dct_input_1d[ctr*8 + 1] = tmp7 + z1 + z4
