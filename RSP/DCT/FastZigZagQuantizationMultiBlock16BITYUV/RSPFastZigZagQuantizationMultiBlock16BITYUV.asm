...
la a1,DCTQBLOCKS // A1 = Y Channel Aligned DRAM Physical RAM Offset ($00000000..$007FFFFF 8MB)
la a2,DCTQBLOCKS+(320*240*2) // A2 = U Channel Aligned DRAM Physical RAM Offset ($00000000..$007FFFFF 8MB)
la a3,DCTQBLOCKS+(320*240*3) // A3 = V Channel Aligned DRAM Physical RAM Offset ($00000000..$007FFFFF 8MB)
...
arch n64.rdp
  ...
  Set_Color_Image IMAGE_DATA_FORMAT_RGBA,SIZE_OF_PIXEL_16B,320-1, DCTQBLOCKS // Set Color Image: FORMAT RGBA,SIZE 16B,WIDTH 256, DRAM ADDRESS
