...
// Instruction Cycles
blt v0,k0,ICZ // IF (QCycles < OldQCycles) OldQCycles = 0
and k0,r0 // OldQCycles = 0 (Delay Slot)
ICZ:
subu t0,v0,k0 // T0 = InstQCycles = QCycles - OldQCycles (Get Last Instruction Quad Cycle Count)
addu k0,r0,v0 // OldQCycles = QCycles


// LCD
addiu a2,a0,LCDC_REG // A2 = MEM_MAP + LCDC_REG
...
addiu a2,a0,STAT_REG // A2 = MEM_MAP + STAT_REG
...
addiu a2,a0,LY_REG // A2 = MEM_MAP + LY_REG
lbu t1,0(a2) // T1 = LY_REG
addiu a2,a0,LYC_REG // A2 = MEM_MAP + LY_REG
...
addiu a2,a0,DIV_REG // A2 = MEM_MAP + DIV_REG
lbu t1,0(a2) // T1 = DIV_REG
addiu t1,1 // DIV_REG++ }
sb t1,0(a2)

NO_DIV:
addiu a2,a0,TAC_REG // A2 = MEM_MAP + TAC_REG
...
TMR_4096:
  ...
  addiu a2,a0,TIMA_REG // A2 = MEM_MAP + TIMA_REG
  ...
  LOOP_4096:
    ...
    bne t0,t2,LOOP_4096
    nop // Delay Slot
    addiu a2,a0,TMA_REG // A2 = MEM_MAP + TMA_REG
...
INTR_LOOP:
  ...
  nop // Delay Slot
  addiu a2,a0,IE_REG // A2 = MEM_MAP + IE_REG
  ...
  sb t1,0(a2)
  subiu sp,2 // SP_REG -= 2
  addiu a2,a0,sp // A2 = MEM_MAP + SP_REG
  sb s4,0(a2) // STACK = PC_REG
  srl t1,s4,8
  sb t1,1(a2)
  lli s4,$40 // PC_REG = $0040
  b INC_INTR
...
// DMA
addiu a2,a0,DMA_REG // A2 = MEM_MAP + DMA_REG
...
addiu a3,a0,OAM_RAM // A3 = MEM_MAP + OAM_RAM
DMA_LOOP:
...
// Joypad
addiu a2,a0,P1_REG // A2 = MEM_MAP + P1_REG
lli t0,$F
