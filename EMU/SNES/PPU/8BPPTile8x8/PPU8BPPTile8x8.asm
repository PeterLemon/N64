...
RDPSNESTILE:
  ...
  while {y} < 28 {
    ...
    while {x} < 32 {
      Sync_Tile // Sync Tile
      Set_Texture_Image IMAGE_DATA_FORMAT_COLOR_INDX,SIZE_OF_PIXEL_8B,8-1, N64TILE+(64*(({y}*32)+{x})) // Set Texture Image: FORMAT COLOR INDEX,SIZE 8B,WIDTH 8, Tile 1 DRAM ADDRESS
