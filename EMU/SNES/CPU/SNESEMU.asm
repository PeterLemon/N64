; N64 'Bare Metal' SNES Emulator by krom (Peter Lemon):
  ...
  C_FLAG: equ   $1 ; P Register Bit 0 Carry Flag (0=No Carry, 1=Carry)
  Z_FLAG: equ   $2 ; P Register Bit 1 Zero Flag (0=Nonzero, 1=Zero)
  I_FLAG: equ   $4 ; P Register Bit 2 IRQ Disable Flag (0=IRQ Enable, 1=IRQ Disable)
  D_FLAG: equ   $8 ; P Register Bit 3 Decimal Mode Flag (0=Normal, 1=BCD Mode for ADC/SBC opcodes)
  B_FLAG: equ  $10 ; P Register Bit 4 Break Flag (0=IRQ/NMI, 1=BRK/PHP Opcode) (Emulation Mode)
  X_FLAG: equ  $10 ; P Register Bit 4 X Flag Indicates Size Of Index Registers (0=16bit, 1=8bit) (Native Mode)
  U_FLAG: equ  $20 ; P Register Bit 5 Unused Flag (Always 1) (Emulation Mode)
  M_FLAG: equ  $20 ; P Register Bit 5 M Flag Indicates Size Of Accumulator (0=16bit, 1=8bit) (Native Mode)
  V_FLAG: equ  $40 ; P Register Bit 6 Overflow Flag (0=No Overflow, 1=Overflow)
  N_FLAG: equ  $80 ; P Register Bit 7 Negative/Sign Flag (0=Positive, 1=Negative)
  E_FLAG: equ $100 ; P Register Bit 8 Emulation Flag (Can Be Accessed Only Via XCE Opcode) (0=Native Mode 65816, 1=Emulation Mode 6502)
...
Start:
  ...
  ;li v1,$73E2 ; V1 = Refresh Cycles 1.78MHz (1780000Hz / 60Hz = 29666 CPU Cycles)
  li v1,$AE7A ; V1 = Refresh Cycles 2.68MHz (2680000Hz / 60Hz = 44666 CPU Cycles)
  ;li v1,$E912 ; V1 = Refresh Cycles 3.58MHz (3580000Hz / 60Hz = 59666 CPU Cycles)
  ...
  lbu t0,RES2_VEC+1(a0) ; PC_REG: Set To 6502 Reset Vector ($FFFC)
  sll t0,8
  lbu s3,RES2_VEC(a0)
  or s3,t0
...
VRAM: ; VRAM 32K Words (64KB)
  dcb $10000,$00 ; Generates $10000 Bytes Containing $00

CGRAM: ; Palette CGRAM 256 Words (512 Bytes)
  dcb 512,$00 ; Generates 512 Bytes Containing $00

OAM: ; OAM 256+16 Words (512+32 Bytes)
  dcb (512+32),$00 ; Generates 512+32 Bytes Containing $00

SPC_RAM: ; SPC Sound RAM (64KB)
  dcb $10000,$00 ; Generates $10000 Bytes Containing $00

SPC_ROM: ; SPC Sound ROM (64 Bytes BIOS Boot ROM)
...
MEM_MAP: ; Memory Map = $10000 Bytes
  ;dcb $10000,$00 ; Generates $10000 Bytes Containing $00
  dcb $8000,$00 ; Generates $8000 Bytes Containing $00
  incbin Test.sfc ; Copy 32768 Bytes of Cartridge into Memory Map