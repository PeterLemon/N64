...
align(256)
  ...
  beqz s0,ORADPXIM0X1    // IF (Result == 0) Z Flag Set
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t0               // P_REG: N Flag = Result MSB
  beqz s0,ORASRSM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  ORASRSM0X1:
  addiu s3,1             // PC_REG++
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t0               // P_REG: N Flag = Result MSB
  beqz s0,EORDPM0X1      // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  EORDPM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t0               // P_REG: N Flag = Result MSB
  beqz s0,EORIMMM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  EORIMMM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t0               // P_REG: N Flag = Result MSB
  beqz s0,EORABSM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  EORABSM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t0               // P_REG: N Flag = Result MSB
  beqz s0,EORDPXM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  EORDPXM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t0               // P_REG: N Flag = Result MSB
  beqz s0,EORABSYM0X1    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  EORABSYM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t0               // P_REG: N Flag = Result MSB
  beqz s0,EORABSXM0X1    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  EORABSXM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  srl t1,t0,8
  sb t1,1(a2)
  beqz t0,RORDPM0X1      // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  RORDPM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  sll t1,8
  or s0,t1
  beqz s0,RORAM0X1       // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  RORAM0X1:
  jr ra
...
align(256)
  ...
  srl t1,t0,8
  sb t1,1(a2)
  beqz t0,RORABSM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  RORABSM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  srl t1,t0,8
  sb t1,1(a2)
  beqz t0,RORDPXM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  RORDPXM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  srl t1,t0,8
  sb t1,1(a2)
  beqz t0,RORABSXM0X1    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  RORABSXM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  blt s2,t0,CPYIMMM0X1C  // IF (Y_REG < Immediate) C Flag Reset
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CPYIMMM0X1Z    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CPYIMMM0X1Z:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  addu a2,s6
  lbu t0,0(a2)
  blt s2,t0,CPYDPM0X1C   // IF (Y_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CPYDPM0X1C:
  subu t0,s2,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CPYDPM0X1Z     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CPYDPM0X1Z:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  or t0,t1
  blt s0,t0,CMPDPM0X1C   // IF (A_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CMPDPM0X1C:
  subu t0,s0,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CMPDPM0X1Z     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CMPDPM0X1Z:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,DECDPM0X1      // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  DECDPM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  or t0,t1
  blt s0,t0,CMPIMMM0X1C  // IF (A_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CMPIMMM0X1C:
  subu t0,s0,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CMPIMMM0X1Z    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CMPIMMM0X1Z:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  addu a2,t0
  lbu t0,0(a2)
  blt s2,t0,CPYABSM0X1C  // IF (Y_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CPYABSM0X1C:
  subu t0,s2,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CPYABSM0X1Z    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CPYABSM0X1Z:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  or t0,t1
  blt s0,t0,CMPABSM0X1C  // IF (A_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CMPABSM0X1C:
  subu t0,s0,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CMPABSM0X1Z    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CMPABSM0X1Z:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t1,0(a2)
  or t0,t1
  addu a2,a0,t0          // Decrement DB_REG:MEM (16-Bit)
  sll t0,s7,16
  addu a2,t0
  lbu t1,1(a2)
  sll t1,8
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,DECABSM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  DECABSM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  or t0,t1
  blt s0,t0,CMPDPXM0X1C  // IF (A_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CMPDPXM0X1C:
  subu t0,s0,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CMPDPXM0X1Z    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CMPDPXM0X1Z:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,DECDPXM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  DECDPXM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  or t0,t1
  blt s0,t0,CMPABSYM0X1C // IF (A_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CMPABSYM0X1C:
  subu t0,s0,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CMPABSYM0X1Z   // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CMPABSYM0X1Z:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  or t0,t1
  blt s0,t0,CMPABSXM0X1C // IF (A_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CMPABSXM0X1C:
  subu t0,s0,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CMPABSXM0X1Z   // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CMPABSXM0X1Z:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t1,0(a2)
  or t0,t1
  addu a2,a0,t0          // Decrement DB_REG:MEM+X_REG (16-Bit)
  sll t0,s7,16
  addu a2,t0
  addu a2,s1
  lbu t1,1(a2)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,DECABSXM0X1    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  DECABSXM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t0,0(a2)
  blt s1,t0,CPXIMMM0X1C  // IF (X_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CPXIMMM0X1C:
  subu t0,s1,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CPXIMMM0X1Z    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CPXIMMM0X1Z:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  addu a2,s6
  lbu t0,0(a2)
  blt s1,t0,CPXDPM0X1C   // IF (X_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CPXDPM0X1C:
  subu t0,s1,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CPXDPM0X1Z     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CPXDPM0X1Z:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,INCDPM0X1      // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  INCDPM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  addu a2,t0
  lbu t0,0(a2)
  blt s1,t0,CPXABSM0X1C  // IF (X_REG < Immediate) C Flag Reset
  andi s5,~C_FLAG        // P_REG: C Flag Reset (Delay Slot)
  ori s5,C_FLAG          // P_REG: C Flag Set
  CPXABSM0X1C:
  subu t0,s1,t0
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,CPXABSM0X1Z    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  CPXABSM0X1Z:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  lbu t1,0(a2)
  or t0,t1
  addu a2,a0,t0          // Increment DB_REG:MEM (16-Bit)
  sll t0,s7,16
  addu a2,t0
  lbu t1,1(a2)
  sll t1,8
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,INCABSM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  INCABSM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
...
align(256)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,INCDPXM0X1     // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  INCDPXM0X1:
  addiu s3,1             // PC_REG++ (Increment Program Counter)
...
align(256)
  ...
  lbu t1,0(a2)
  or t0,t1
  addu a2,a0,t0          // Increment DB_REG:MEM+X_REG (16-Bit)
  sll t0,s7,16
  addu a2,t0
  addu a2,s1
  lbu t1,1(a2)
  ...
  andi s5,~N_FLAG        // P_REG: N Flag Reset
  or s5,t1               // P_REG: N Flag = Result MSB
  beqz t0,INCABSXM0X1    // IF (Result == 0) Z Flag Set
  ori s5,Z_FLAG          // P_REG: Z Flag Set (Delay Slot)
  andi s5,~Z_FLAG        // P_REG: Z Flag Reset
  INCABSXM0X1:
  addiu s3,2             // PC_REG += 2 (Increment Program Counter)
