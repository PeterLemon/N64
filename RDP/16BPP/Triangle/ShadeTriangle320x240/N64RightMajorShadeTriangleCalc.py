...
#tri = (25.0, 100.0), (75.0, 50.0), (25.0, 50.0) # Y Sorted Triangle
#tri = (150.0, 100.0), (150.0, 50.0), (100.0, 50.0) # Y Sorted Triangle
#tri = (175.0, 100.0), (225.0, 100.0), (225.0, 50.0) # Y Sorted Triangle
#tri = (250.0, 100.0), (300.0, 100.0), (250.0, 50.0) # Y Sorted Triangle
#tri = (25.0, 200.0), (75.0, 175.0), (25.0, 150.0) # Y Sorted Triangle
#tri = (125.0, 200.0), (150.0, 150.0), (100.0, 150.0) # Y Sorted Triangle
#tri = (225.0, 200.0), (175.0, 175.0), (225.0, 150.0) # Y Sorted Triangle
tri = (250.0, 200.0), (300.0, 200.0), (275.0, 150.0) # Y Sorted Triangle
...
print ("Shade_Triangle %i, 0, 0, %i,%i,%i, %i,%i, %i,%i, %i,%i, %i,%i, %i,%i, %i,%i" % (dir, YL,YM,YH, XL,XLf, DxLDy,DxLDyf, XM,XMf, DxHDy,DxHDyf, XM,XMf, DxMDy,DxMDyf))
