// N64 'Bare Metal' 16BPP 320x240 Copy Texture Triangle TLUT RGBA8B RDP Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "CopyTextureTriangle16BPPTLUTRGBA8B320X240.N64", create
