...
#tri = (64.0, 68.0), (80.0, 52.0), (64.0, 52.0) # Y Sorted Triangle
#tri = (64.0, 68.0), (80.0, 68.0), (80.0, 52.0) # Y Sorted Triangle

#tri = (72.0, 130.0), (80.0, 122.0), (72.0, 122.0) # Y Sorted Triangle
#tri = (72.0, 130.0), (80.0, 130.0), (80.0, 122.0) # Y Sorted Triangle

#tri = (72.0, 200.0), (80.0, 192.0), (72.0, 192.0) # Y Sorted Triangle
#tri = (72.0, 200.0), (80.0, 200.0), (80.0, 192.0) # Y Sorted Triangle

#tri = (136.0, 76.0), (168.0, 44.0), (136.0, 44.0) # Y Sorted Triangle
#tri = (136.0, 76.0), (168.0, 76.0), (168.0, 44.0) # Y Sorted Triangle

#tri = (152.0, 130.0), (168.0, 114.0), (152.0, 114.0) # Y Sorted Triangle
#tri = (152.0, 130.0), (168.0, 130.0), (168.0, 114.0) # Y Sorted Triangle

#tri = (152.0, 200.0), (168.0, 184.0), (152.0, 184.0) # Y Sorted Triangle
#tri = (152.0, 200.0), (168.0, 200.0), (168.0, 184.0) # Y Sorted Triangle

#tri = (212.0, 92.0), (276.0, 28.0), (212.0, 28.0) # Y Sorted Triangle
#tri = (212.0, 92.0), (276.0, 92.0), (276.0, 28.0) # Y Sorted Triangle

#tri = (244.0, 130.0), (276.0, 98.0), (244.0, 98.0) # Y Sorted Triangle
#tri = (244.0, 130.0), (276.0, 130.0), (276.0, 98.0) # Y Sorted Triangle

#tri = (244.0, 200.0), (276.0, 168.0), (244.0, 168.0) # Y Sorted Triangle
tri = (244.0, 200.0), (276.0, 200.0), (276.0, 168.0) # Y Sorted Triangle
