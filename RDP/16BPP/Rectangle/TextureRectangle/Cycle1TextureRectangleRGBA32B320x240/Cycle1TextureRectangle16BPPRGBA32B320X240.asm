...
RDPBuffer:
  ...
  Set_Texture_Image SIZE_OF_PIXEL_32B|(8-1), Texture8x8 ; Set Texture Image: SIZE 32B, WIDTH 8, Texture8x8 DRAM ADDRESS
  ...
  Sync_Tile ; Sync Tile
  Set_Texture_Image SIZE_OF_PIXEL_32B|(16-1), Texture16x16 ; Set Texture_Image: SIZE 32B, WIDTH 16, Texture16x16 DRAM ADDRESS
  ...
  Sync_Tile ; Sync Tile
  Set_Texture_Image SIZE_OF_PIXEL_32B|(32-1), Texture32x32 ; Set Texture Image: SIZE 32B, WIDTH 32, Texture32x32 DRAM ADDRESS
  Set_Tile SIZE_OF_PIXEL_32B|(8<<9)|$000, (0<<24)|MIRROR_S|MIRROR_T|MASK_S_4|MASK_T_4 ; Set Tile: SIZE 32B, Tile Line Size 8 (64bit Words), TMEM Address $000, Tile 0, MIRROR S, MIRROR T, MASK S 4, MASK T 4
  ...
  Sync_Tile ; Sync Tile
  Set_Tile SIZE_OF_PIXEL_32B|(8<<9)|$000, 0<<24 ; Set Tile: SIZE 32B, Tile Line Size 8 (64bit Words), TMEM Address $000, Tile 0
