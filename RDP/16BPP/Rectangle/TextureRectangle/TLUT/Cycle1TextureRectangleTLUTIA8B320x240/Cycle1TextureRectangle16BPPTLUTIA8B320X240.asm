// N64 'Bare Metal' 16BPP 320x240 Cycle1 Texture Rectangle TLUT IA8B RDP Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "Cycle1TextureRectangle16BPPTLUTIA8B320X240.N64", create
...
Tlut:
  dw $0000,$FFFF,$00FF,$80FF // 4x16B = 8 Bytes