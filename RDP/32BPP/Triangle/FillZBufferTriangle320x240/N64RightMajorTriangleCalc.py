...
#tri = (50.0, 75.0), (75.0, 50.0), (25.0, 50.0) # Y Sorted Triangle
#tri = (25.0, 100.0), (75.0, 100.0), (50.0, 25.0) # Y Sorted Triangle

#tri = (125.0, 75.0), (150.0, 50.0), (100.0, 50.0) # Y Sorted Triangle
#tri = (100.0, 100.0), (150.0, 100.0), (125.0, 25.0) # Y Sorted Triangle

#tri = (175.0, 100.0), (200.0, 75.0), (175.0, 50.0) # Y Sorted Triangle
#tri = (225.0, 100.0), (150.0, 75.0), (225.0, 50.0) # Y Sorted Triangle

#tri = (250.0, 100.0), (275.0, 75.0), (250.0, 50.0) # Y Sorted Triangle
#tri = (300.0, 100.0), (225.0, 75.0), (300.0, 50.0) # Y Sorted Triangle

#tri = (50.0, 175.0), (75.0, 150.0), (25.0, 150.0) # Y Sorted Triangle
#tri = (25.0, 200.0), (75.0, 200.0), (50.0, 125.0) # Y Sorted Triangle

#tri = (125.0, 175.0), (150.0, 150.0), (100.0, 150.0) # Y Sorted Triangle
#tri = (100.0, 200.0), (150.0, 200.0), (125.0, 125.0) # Y Sorted Triangle

#tri = (175.0, 200.0), (200.0, 175.0), (175.0, 150.0) # Y Sorted Triangle
#tri = (225.0, 200.0), (150.0, 175.0), (225.0, 150.0) # Y Sorted Triangle

#tri = (250.0, 200.0), (275.0, 175.0), (250.0, 150.0) # Y Sorted Triangle
tri = (300.0, 200.0), (225.0, 175.0), (300.0, 150.0) # Y Sorted Triangle
...
print ("Fill_ZBuffer_Triangle %i, 0, 0, %i,%i,%i, %i,%i, %i,%i, %i,%i, %i,%i, %i,%i, %i,%i" % (dir, YL,YM,YH, XL,XLf, DxLDy,DxLDyf, XM,XMf, DxHDy,DxHDyf, XM,XMf, DxMDy,DxMDyf))
