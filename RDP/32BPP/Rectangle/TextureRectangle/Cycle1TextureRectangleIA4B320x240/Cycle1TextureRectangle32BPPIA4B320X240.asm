; N64 'Bare Metal' 32BPP 320x240 Cycle1 Texture Rectangle IA4B RDP Demo by krom (Peter Lemon):
...
RDPBuffer:
  ...
  Set_Fill_Color $FFFF00FF ; Set Fill Color: PACKED COLOR 32B R8G8B8A8 Pixels
  ...
  Sync_Tile ; Sync Tile
  Set_Tile IMAGE_DATA_FORMAT_IA|SIZE_OF_PIXEL_4B|(1<<9)|$000, (0<<24) ; Set Tile: IA, SIZE 4B, Tile Line Size 1 (64bit Words), TMEM Address $000, Tile 0
  ...
  Sync_Tile ; Sync Tile
  Set_Tile IMAGE_DATA_FORMAT_IA|SIZE_OF_PIXEL_4B|(2<<9)|$000, (0<<24)|MIRROR_S|MIRROR_T|MASK_S_4|MASK_T_4 ; Set Tile: IA, SIZE 4B, Tile Line Size 2 (64bit Words), TMEM Address $000, Tile 0, MIRROR S, MIRROR T, MASK S 4, MASK T 4
  ...
  Sync_Tile ; Sync Tile
  Set_Tile IMAGE_DATA_FORMAT_IA|SIZE_OF_PIXEL_4B|(2<<9)|$000, (0<<24) ; Set Tile: IA, SIZE 4B, Tile Line Size 2 (64bit Words), TMEM Address $000, Tile 0
  ...
  Sync_Tile ; Sync Tile
  Set_Tile IMAGE_DATA_FORMAT_IA|SIZE_OF_PIXEL_4B|(4<<9)|$000, (0<<24) ; Set Tile: IA, SIZE 4B, Tile Line Size 4 (64bit Words), TMEM Address $000, Tile 0
