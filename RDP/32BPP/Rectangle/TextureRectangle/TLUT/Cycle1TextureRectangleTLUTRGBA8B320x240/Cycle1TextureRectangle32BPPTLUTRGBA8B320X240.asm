// N64 'Bare Metal' 32BPP 320x240 Cycle1 Texture Rectangle TLUT RGBA8B RDP Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "Cycle1TextureRectangle32BPPTLUTRGBA8B320X240.N64", create
...
Tlut:
  dw $0000,$FFFF,$0001,$F001 // 4x16B = 8 Bytes