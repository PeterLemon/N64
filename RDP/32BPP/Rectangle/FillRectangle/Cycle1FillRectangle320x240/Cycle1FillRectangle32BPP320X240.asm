// N64 'Bare Metal' 32BPP 320x240 Cycle1 Fill Rectangle RDP Demo by krom (Peter Lemon):
arch n64.cpu
endian msb
output "Cycle1FillRectangle32BPP320X240.N64", create
...
arch n64.rdp
  ...
  Set_Blend_Color $FFFF00FF // Set Blend Color: R 255,G 255,B 0,A 255
  ...
  Set_Blend_Color $00FFFFFF // Set Blend Color: R 0,G 255,B 255,A 255
