// Tests texture wrap around for texture coordinates, including subpixel accuracy
// This reproduces the black lines issue in e.g. Mario Kart's character selection screen
output "TextureCoordinates2b.N64", create
arch n64.cpu
endian msb
...
arch n64.rdp
  ...
  macro Rectangle(variable left, variable top, variable height, variable dtdy, variable t_5) {
    ...
    Set_Other_Modes FORCE_BLEND|CYCLE_TYPE_1_CYCLE|BI_LERP_0|BI_LERP_1|RGB_DITHER_SEL_NO_DITHER|ATOMIC_PRIM
    Sync_Pipe
    Sync_Load
    Sync_Tile
  ...
  while columnIndex < 5 {
    ...
    while rowIndex < 5 {
      ...
      Rectangle(((10 + columnIndex * 16) << 2), ((82 + rowIndex * 12) << 2) + columnIndex, (8 << 2) + rowIndex, 1<<10, 8)

      // t = 16 (half of a pixel)
      Rectangle(((10 + columnIndex * 16) << 2), ((154 + rowIndex * 12) << 2) + columnIndex, (8 << 2) + rowIndex, 1<<10, 16)
